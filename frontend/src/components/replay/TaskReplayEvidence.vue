...
.evidence-image-link { display:block; aspect-ratio:16/9; overflow:hidden; border-bottom:1px solid var(--border-color); background:var(--panel-muted); }.evidence-image-link img { width:100%; height:100%; object-fit:contain; }
