...
.test-agent-hardening-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;padding-top:14px}.test-agent-hardening-grid label{display:grid;gap:6px;color:var(--text-muted);font-size:10.5px}.test-agent-hardening-grid select{min-width:0;height:var(--control-height,34px);padding:0 30px 0 var(--control-padding-x,10px);border:1px solid var(--border-color);border-radius:var(--radius-md,6px);color:var(--text-primary);background:var(--control-bg);outline:0;transition:border-color .15s ease,box-shadow .15s ease}.test-agent-hardening-grid select:focus{border-color:var(--accent-blue);box-shadow:var(--focus-ring)}.test-agent-hardening-toggles{display:grid;gap:8px;margin:12px 0}.test-agent-hardening-toggles label{display:flex;align-items:center;gap:8px;color:var(--text-secondary);font-size:10.5px}@media(max-width:900px){.test-agent-hardening-grid{grid-template-columns:1fr}}
</style>
