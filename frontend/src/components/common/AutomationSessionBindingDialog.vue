...
.dialog-body{display:grid;gap:9px;padding:15px 16px}.title-field{display:grid;gap:6px;margin-bottom:4px}.title-field span{font-size:11px;font-weight:750;color:var(--text-secondary)}.title-field input{height:36px;padding:0 10px;border:1px solid var(--border-color);border-radius:7px;background:var(--bg-secondary);color:var(--text-primary);outline:none}.title-field input:focus{border-color:var(--accent-blue)}
...
footer{display:flex;justify-content:flex-end;gap:8px;padding:12px 16px;border-top:1px solid var(--border-color)}footer button{height:34px;padding:0 14px;border-radius:7px;font:inherit;font-size:11px;font-weight:750;cursor:pointer}.secondary{border:1px solid var(--border-color);background:transparent;color:var(--text-secondary)}.primary{border:1px solid var(--accent-blue);background:var(--accent-blue);color:white}.primary:disabled{opacity:.55;cursor:not-allowed}
</style>
