...
@media(max-width:700px) { .runtime-config-overlay { padding:8px; } .runtime-config-modal { max-height:calc(100vh - 16px); } .config-toolbar { align-items:stretch; flex-wrap:wrap; } .config-toolbar label { width:100%; flex-basis:100%; } .toolchain-panel { flex:0 0 auto; max-height:min(52vh,calc(100vh - 412px)); overflow-y:auto; } .profiles { flex:1 1 auto; min-height:120px; } .toolchain-heading { align-items:flex-start; flex-wrap:wrap; } .toolchain-heading > button { width:100%; } .toolchain-grid,.field-grid { grid-template-columns:1fr; } .toolchain-options { align-items:flex-start; flex-direction:column; } }
</style>
