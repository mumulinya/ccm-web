...
.address-bar { min-width:0; height:var(--control-height,34px); flex:1; display:flex; align-items:center; gap:7px; padding-left:var(--control-padding-x,10px); border:1px solid var(--border-color,rgba(15,23,42,.12)); border-radius:var(--radius-md,6px); background:var(--control-bg,var(--surface,var(--bg-primary,#fff))); color:var(--text-muted); }.address-bar:focus-within { border-color:var(--accent-blue,#2563eb); box-shadow:var(--focus-ring,0 0 0 3px color-mix(in srgb,var(--accent-blue,#2563eb) 10%,transparent)); }.address-bar input { min-width:0; flex:1; min-height:0;padding:0;border:0;border-radius:0;outline:0;background:transparent;box-shadow:none;color:var(--text-primary);font:12px ui-monospace,SFMono-Regular,Consolas,monospace; }.address-bar button { width:30px; height:30px; display:grid; place-items:center; border:0; background:transparent; color:var(--text-muted); cursor:pointer; }
...
.create-folder-row { min-height:52px; display:grid; grid-template-columns:28px minmax(0,1fr) auto auto; align-items:center; gap:8px; padding:8px 14px; border-bottom:1px solid var(--border-color,rgba(15,23,42,.1)); color:#b7791f; background:color-mix(in srgb,#f59e0b 5%,transparent); }.create-folder-row input { min-width:0; height:var(--control-height,34px); padding:0 var(--control-padding-x,10px); border:1px solid var(--border-color); border-radius:var(--radius-md,6px); outline:0; background:var(--control-bg,var(--surface,var(--bg-primary,#fff))); color:var(--text-primary); font-size:12px; }.create-folder-row input:focus{border-color:var(--accent-blue,#2563eb);box-shadow:var(--focus-ring)}.create-folder-row .create-confirm { border-color:var(--accent-blue,#2563eb); background:var(--accent-blue,#2563eb); color:#fff; }.create-folder-row .create-cancel { background:transparent; }
