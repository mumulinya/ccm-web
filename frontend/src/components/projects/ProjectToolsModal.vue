...
textarea{width:100%;resize:vertical;box-sizing:border-box;border:1px solid var(--border-color);border-radius:var(--radius-md,6px);padding:9px var(--control-padding-x,10px);background:var(--control-bg);color:var(--text-primary);font:inherit;font-size:11px;line-height:1.5;outline:0;transition:border-color .15s ease,box-shadow .15s ease}textarea:focus{border-color:var(--accent-blue);box-shadow:var(--focus-ring)}.mono{font-family:var(--font-mono,monospace)}
