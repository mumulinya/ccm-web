<template>
  <div class="knowledge-base-page">
    ...
    <KnowledgeChunksDrawer
      ...
      :doc-chunks="docChunks"
      :doc-original-content="docOriginalContent"
      :chunks-loading="chunksLoading"
      :original-loading="originalLoading"
      :drawer-sub-tab="drawerSubTab"
      @close="showChunksDrawer = false"
      @show-chunks="drawerSubTab = 'chunks'"
      @show-original="switchDrawerToOriginal"
    />

    <KnowledgeTagEditorModal
      v-model:new-tag="newTagInput"
      :visible="showTagEditor"
      :doc="tagEditingDoc"
      :tags="tagEditingList"
      @close="showTagEditor = false"
      @add-tag="addEditingTag"
      @remove-tag="removeEditingTag"
      @save="saveDocTags"
    />
  </div>
</template>
