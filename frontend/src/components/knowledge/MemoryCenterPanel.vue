...
.search-box { max-width: 420px; height: var(--control-height, 34px); padding: 0 var(--control-padding-x, 10px); display: flex; align-items: center; gap: 8px; border: 1px solid var(--border-color); border-radius: var(--radius-md, 6px); background: var(--control-bg); }.search-box:focus-within { border-color:var(--accent-blue); box-shadow:var(--focus-ring); }.search-box input { width: 100%; min-height:0; padding:0; border: 0; border-radius:0; outline: 0; background: transparent; box-shadow:none; }
...
.field-grid { margin-top: 18px; display: grid; grid-template-columns: repeat(4, minmax(150px, 1fr)); gap: 14px; }.field-grid label, .edit-modal label { display: grid; gap: 6px; }.field-grid label span, .edit-modal label span { color: var(--text-secondary); font-size: 11px; font-weight: 600; }.field-grid input, .field-grid select, .field-grid textarea, .edit-modal input, .edit-modal select, .edit-modal textarea { width:100%; box-sizing:border-box; border:1px solid var(--border-color); border-radius:var(--radius-md,6px); background:var(--control-bg); color:inherit; outline:none; }.field-grid input, .field-grid select, .edit-modal input, .edit-modal select { height:var(--control-height,34px); padding:0 var(--control-padding-x,10px); }.field-grid input:focus, .field-grid select:focus, .field-grid textarea:focus, .edit-modal input:focus, .edit-modal select:focus, .edit-modal textarea:focus { border-color:var(--accent-blue); box-shadow:var(--focus-ring); }.field-grid input:disabled { background: var(--panel-muted); color: var(--text-muted); }
