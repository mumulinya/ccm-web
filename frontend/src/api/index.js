...
export const groupsApi = {
  ...
  compact: (id, sessionId, customInstructions = '') => api('/api/groups/memory/compact', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ group_id: id, session_id: sessionId, custom_instructions: customInstructions }) }),
