...
- `git diff --check -- backend/modules/collaboration/collaboration.ts backend/modules/collaboration/display.ts scripts/main-agent-decision-ui-selftest.mjs docs/main-agent-workchain/group-main-agent/acceptance-and-delivery/2026-07-07-group-legacy-completion-message-visible-summary-v1.md`
- `npm run check`
