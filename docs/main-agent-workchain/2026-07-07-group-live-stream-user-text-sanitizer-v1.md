...
- `git diff --check -- frontend/src/components/collaboration/GroupChat.vue scripts/main-agent-decision-ui-selftest.mjs docs/main-agent-workchain/2026-07-07-group-live-stream-user-text-sanitizer-v1.md`
- `npm run check`
