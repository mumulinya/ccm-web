...
- `git diff --check -- frontend/src/components/global/GlobalAgent.vue scripts/main-agent-decision-ui-selftest.mjs docs/main-agent-workchain/global-agent/conversation-and-ui/2026-07-07-global-completion-visible-summary-v1.md`
- `npm run check`
