...
- `git diff --check -- backend/modules/collaboration/collaboration.ts frontend/visual-regression/main-agent-display-fixture.js scripts/main-agent-decision-ui-selftest.mjs docs/main-agent-workchain/shared-workchain/planning-and-todo/2026-07-07-acceptance-result-explanation-wording-v1.md`：通过，仅提示 Windows 换行转换。
- `npm run check`：通过。
