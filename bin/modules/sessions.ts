...
import { sendJson, CCM_DIR, SESSIONS_DIR, UPLOAD_DIR, GROUP_MESSAGES_DIR } from "../utils";
...
export function handleSessionsApi(pathname: string, req: any, res: any, parsed: any): boolean {
  ...
  if (pathname === "/api/search" && req.method === "GET") {
    ...
    sendJson(res, { success: true, results: results.slice(0, limit), total: results.length });
    return true;
  }
