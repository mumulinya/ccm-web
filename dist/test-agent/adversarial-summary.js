...
exports.buildAdversarialEvidenceSummary = buildAdversarialEvidenceSummary;
exports.formatAdversarialEvidenceSummaryLine = formatAdversarialEvidenceSummaryLine;
exports.adversarialEvidenceSummaryErrors = adversarialEvidenceSummaryErrors;
...
function resultItems(input) {
    ...
    const browser = input.browserResults
        .filter(item => item.adversarial === true)
        .map(item => {
...
function statusFor(required, waived, counts, passedRelevant) {
    if (counts.failed > 0)
        return "failed";
    if (counts.blocked > 0)
        return "blocked";
...
function buildAdversarialEvidenceSummary(input) {
...
function formatAdversarialEvidenceSummaryLine(summary) {
    if (!summary) {
...
function adversarialEvidenceSummaryErrors(summary, httpResults, browserResults, originalUserGoal = "", acceptanceCriteria = [], label = "adversarial evidence summary") {
...
//# sourceMappingURL=adversarial-summary.js.map