...
function initializeBuiltInSessionCompactionHooks() {
    ...
    (0, session_compaction_core_1.registerSessionCompactionHook)("pre_compact", (input) => (0, session_compaction_command_hooks_1.runConfiguredSessionCompactionCommandHooks)("pre_compact", input));
    (0, session_compaction_core_1.registerSessionCompactionHook)("session_start", (input) => (0, session_compaction_command_hooks_1.runConfiguredSessionCompactionCommandHooks)("session_start", input));
    (0, session_compaction_core_1.registerSessionCompactionHook)("post_compact", (input) => (0, session_compaction_command_hooks_1.runConfiguredSessionCompactionCommandHooks)("post_compact", input));
