...
function normalizeCcmUnifiedSummary(value, sourceMessageIds = []) {
    ...
    const aliases = {
        ...
        decisions: "decisions", keyConcepts: "decisions",
        ...
        pendingWork: "pendingWork", pendingTasks: "pendingWork", unresolved: "pendingWork", currentWork: "pendingWork",
        risksAndBlockers: "risksAndBlockers", errorsAndFixes: "risksAndBlockers", risks: "risksAndBlockers", errors: "risksAndBlockers", blockers: "risksAndBlockers",
        fileReferences: "fileReferences", filesAndCode: "fileReferences", filesAndResources: "fileReferences", files: "fileReferences",
        ...
        nextActions: "nextActions", nextStep: "nextActions", nextSteps: "nextActions", next_actions: "nextActions",
