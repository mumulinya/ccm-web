...
const tools = [
    ...
    { name: "list_test_targets", description: "列出当前签名群聊中可供 TestAgent 选择的项目验收环境，不返回登录凭据。", roles: ["group-main-agent"], inputSchema: { type: "object", properties: {}, additionalProperties: false } },
    {
        name: "start_test_run",
...
function callTool(context, name, args) {
    if (name === "list_test_targets")
        return (0, group_test_targets_1.listGroupTestTargets)(context.groupId);
