    ...
    try {
        const options = {
            ...
            providerContextCache: {
                ...
                source: "semantic_permission_review",
                cacheAffinity: (0, agent_cache_affinity_1.semanticCacheAffinity)({
                    scope: context.groupId ? "group" : "project",
                    scopeId: context.groupId || context.project,
                    exactSessionId: context.groupId ? context.groupSessionId : (context.projectSessionId || context.taskId),
                    taskId: context.taskId,
                    decisionKind: "permission_review",
                }),
            },
        };
