...
function buildGroupMicroCompactPlan(messages, options = {}) {
    void options;
    // Compatibility shape only. Group formal compaction used to perform a
    // second size/time based micro-compaction while building its summary. That
    // path is retired; V2 request preflight owns tool-result reduction and the
    // formal fallback sees the unchanged authoritative snapshot.
    return {
