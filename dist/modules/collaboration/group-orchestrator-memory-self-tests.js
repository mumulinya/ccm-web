"use strict";
// group-orchestrator-memory-self-tests.ts — merged from 2 part files (behavior-freeze merge).
...
// ===== merged from group-orchestrator-memory-self-tests-part-01.ts =====
...
function runWorkerContextPtlEmergencyDowngradeSelfTest() {
    ...
    const ptlFile = (0, group_orchestrator_1.getWorkerContextPtlEmergencyHintFileForCoordinator)(groupId);
    ...
    try {
        ...
        const ptlHint = (0, group_orchestrator_1.readWorkerContextPtlEmergencyHintForCoordinator)(groupId);
...
function runWorkerContextCompletionMemoryCompactionPreservationSelfTest() {
    ...
    const cleanupFiles = groups.flatMap(groupId => [
        (0, group_orchestrator_1.getWorkerContextCompactHookLedgerFileForCoordinator)(groupId),
        (0, group_orchestrator_1.getWorkerContextCompactOutcomeLedgerFileForCoordinator)(groupId),
        (0, group_orchestrator_1.getWorkerContextCompactStrategyMemoryFileForCoordinator)(groupId),
        (0, group_orchestrator_1.getWorkerContextPtlEmergencyHintFileForCoordinator)(groupId),
    ...
    const runScenario = (kind, groupId) => {
        ...
        const initialPacket = (0, group_orchestrator_1.buildWorkerContextPacketForAssignment)(baseAssignment, "", replayBriefs, options);
        const initialGate = (0, group_orchestrator_1.buildWorkerContextPreDispatchGateForCoordinator)(baseAssignment, initialPacket);
        const result = (0, group_orchestrator_1.maybeRetryWorkerContextPacketCompactionForCoordinator)(baseAssignment, "", replayBriefs, initialPacket, initialGate, options);
        const retry = result.retry || result.packet?.context_compaction_retry || {};
    ...
    try {
        ...
        const rejectedPreservation = (0, group_orchestrator_1.buildPostCompactReceiptMemoryUsageRepairCompletionPreservationForCoordinator)(memoryScenario.initialPacket, tamperedPacketBase, { retry_id: "phase184-tampered" });
        ...
        const tamperedGate = (0, group_orchestrator_1.buildWorkerContextPreDispatchGateForCoordinator)(baseAssignmentFor(groups[0], "tampered", "phase184 tampered"), tamperedPacket);
...
function runWorkerContextIgnoreMemoryPolicySelfTest() {
    ...
    try {
        ...
        const packet = (0, group_orchestrator_1.buildWorkerContextPacketForAssignment)(baseAssignment, "", [], {
            group,
            memory,
        ...
        const binding = (0, group_orchestrator_1.recordWorkerContextPacketAssignmentBindingForCoordinator)(groupId, assignment) || {};
...
function runWorkerContextPressureProvenanceProviderDispatchGateSelfTest() {
    ...
    try {
        ...
        const recoveredPacket = (0, group_orchestrator_1.buildWorkerContextPacketForAssignment)(baseAssignment, "", [], {
            group,
            workerContextUsageOptions: { maxTokens: 5000, autoCompactBufferTokens: 120 },
        });
        const recoveredGate = (0, group_orchestrator_1.buildWorkerContextPreDispatchGateForCoordinator)(baseAssignment, recoveredPacket);
        const checks = {
...
// ===== merged from group-orchestrator-memory-self-tests-part-02.ts =====
// Extracted functional module. The original entry remains a compatibility facade.
...
//# sourceMappingURL=group-orchestrator-memory-self-tests.js.map