...
exports.canonicalSemanticRecallText = canonicalSemanticRecallText;
exports.semanticRecallFeatures = semanticRecallFeatures;
exports.semanticRecallCorpusStats = semanticRecallCorpusStats;
exports.roundSemanticRecallScore = roundSemanticRecallScore;
exports.scoreSemanticNaturalLanguageRecall = scoreSemanticNaturalLanguageRecall;
exports.semanticRecallDuplicateOf = semanticRecallDuplicateOf;
exports.extractSemanticRecallSnippet = extractSemanticRecallSnippet;
exports.scorePostCompactCandidateUsageHint = scorePostCompactCandidateUsageHint;
exports.normalizeWorkerContextPressureStatus = normalizeWorkerContextPressureStatus;
exports.normalizeWorkerContextPressureRecallSignals = normalizeWorkerContextPressureRecallSignals;
exports.queryMentionsWorkerContextPressure = queryMentionsWorkerContextPressure;
exports.classifyWorkerContextPressureRecallDoc = classifyWorkerContextPressureRecallDoc;
exports.scoreWorkerContextPressureRecall = scoreWorkerContextPressureRecall;
exports.normalizeWorkerContextPressureRecallUsageState = normalizeWorkerContextPressureRecallUsageState;
exports.roundPressureRecallUsageWeight = roundPressureRecallUsageWeight;
exports.normalizeWorkerContextPressureRecallUsageAging = normalizeWorkerContextPressureRecallUsageAging;
exports.workerContextPressureRecallUsageEntryTimeMs = workerContextPressureRecallUsageEntryTimeMs;
exports.workerContextPressureRecallUsageAgeDays = workerContextPressureRecallUsageAgeDays;
exports.workerContextPressureRecallUsageDecayWeight = workerContextPressureRecallUsageDecayWeight;
exports.workerContextPressureRecallStatsKey = workerContextPressureRecallStatsKey;
exports.workerContextPressureRecallUsageRecommendation = workerContextPressureRecallUsageRecommendation;
exports.buildWorkerContextPressureRecallUsageEntry = buildWorkerContextPressureRecallUsageEntry;
exports.getGroupPressureRecallUsageRepairWorkItemsFile = getGroupPressureRecallUsageRepairWorkItemsFile;
exports.normalizePressureRecallUsageRepairStatus = normalizePressureRecallUsageRepairStatus;
exports.pressureRecallUsageRepairOpen = pressureRecallUsageRepairOpen;
exports.normalizeWorkerContextPressureRecallUsageRepairHints = normalizeWorkerContextPressureRecallUsageRepairHints;
exports.matchWorkerContextPressureRecallUsageRepairHint = matchWorkerContextPressureRecallUsageRepairHint;
exports.normalizeWorkerContextPressureRecallUsageStatsRow = normalizeWorkerContextPressureRecallUsageStatsRow;
exports.buildWorkerContextPressureRecallUsageStatsRowsFromEntries = buildWorkerContextPressureRecallUsageStatsRowsFromEntries;
exports.summarizeWorkerContextPressureRecallUsageRows = summarizeWorkerContextPressureRecallUsageRows;
exports.sortWorkerContextPressureRecallUsageRows = sortWorkerContextPressureRecallUsageRows;
exports.filterWorkerContextPressureRecallUsageRows = filterWorkerContextPressureRecallUsageRows;
exports.buildWorkerContextPressureRecallUsageSummaryFromRows = buildWorkerContextPressureRecallUsageSummaryFromRows;
...
exports.normalizeWorkerContextPressureRecallUsageHints = normalizeWorkerContextPressureRecallUsageHints;
exports.scoreWorkerContextPressureRecallUsageHint = scoreWorkerContextPressureRecallUsageHint;
exports.normalizePressureProvenanceDispatchFeedbackPolicyForRecall = normalizePressureProvenanceDispatchFeedbackPolicyForRecall;
exports.pressureProvenanceFeedbackRecallRepairQuery = pressureProvenanceFeedbackRecallRepairQuery;
exports.pressureProvenanceFeedbackRecallUnderRepair = pressureProvenanceFeedbackRecallUnderRepair;
exports.scoreWorkerContextPressureFeedbackPolicyRecallRisk = scoreWorkerContextPressureFeedbackPolicyRecallRisk;
exports.pressureMemoryProvenanceStringList = pressureMemoryProvenanceStringList;
exports.pressureMemoryProvenanceRowsFromRawRecovery = pressureMemoryProvenanceRowsFromRawRecovery;
exports.pressureProvenancePreDispatchComplianceInputRows = pressureProvenancePreDispatchComplianceInputRows;
exports.pressureProvenancePreDispatchComplianceRowId = pressureProvenancePreDispatchComplianceRowId;
exports.normalizePressureProvenancePreDispatchComplianceRows = normalizePressureProvenancePreDispatchComplianceRows;
exports.mergePressureProvenancePreDispatchComplianceRows = mergePressureProvenancePreDispatchComplianceRows;
exports.pressureProvenancePreDispatchComplianceArchive = pressureProvenancePreDispatchComplianceArchive;
exports.renderPressureProvenancePreDispatchComplianceBody = renderPressureProvenancePreDispatchComplianceBody;
exports.pressureProvenancePreDispatchComplianceRecoveryRowId = pressureProvenancePreDispatchComplianceRecoveryRowId;
exports.normalizePressureProvenancePreDispatchComplianceRecoveryRows = normalizePressureProvenancePreDispatchComplianceRecoveryRows;
exports.mergePressureProvenancePreDispatchComplianceRecoveryRows = mergePressureProvenancePreDispatchComplianceRecoveryRows;
exports.pressureProvenancePreDispatchComplianceRecoveryArchive = pressureProvenancePreDispatchComplianceRecoveryArchive;
exports.renderPressureProvenancePreDispatchComplianceRecoveryBody = renderPressureProvenancePreDispatchComplianceRecoveryBody;
exports.normalizePressureProvenanceDispatchPolicyKey = normalizePressureProvenanceDispatchPolicyKey;
exports.pressureProvenanceDispatchPolicyAttributionMatches = pressureProvenanceDispatchPolicyAttributionMatches;
exports.pressureProvenanceDispatchPolicyAttributionKey = pressureProvenanceDispatchPolicyAttributionKey;
...
exports.normalizeRecallScope = normalizeRecallScope;
exports.getGroupTypedMemoryRecallScopeStats = getGroupTypedMemoryRecallScopeStats;
exports.recordGroupTypedMemoryRecallUnlocked = recordGroupTypedMemoryRecallUnlocked;
exports.recordGroupTypedMemoryRecall = recordGroupTypedMemoryRecall;
exports.typedMemoryStaleCandidateChecksum = typedMemoryStaleCandidateChecksum;
exports.typedMemoryStaleCandidateRejection = typedMemoryStaleCandidateRejection;
exports.recordGroupTypedMemoryStaleCandidates = recordGroupTypedMemoryStaleCandidates;
exports.verifyTypedMemoryStaleCandidateCurrentSource = verifyTypedMemoryStaleCandidateCurrentSource;
exports.resolveGroupTypedMemoryStaleCandidate = resolveGroupTypedMemoryStaleCandidate;
exports.buildGroupTypedMemoryRecallFreshness = buildGroupTypedMemoryRecallFreshness;
...
function semanticRecallFeatures(value) {
    ...
    const concepts = typed_memory_shared_1.SEMANTIC_RECALL_CONCEPTS.filter(([, pattern]) => pattern.test(lower)).map(([id]) => id);
    ...
    const relations = (0, typed_memory_shared_1.uniqueStrings)([
    ...
    const semanticTokens = (0, typed_memory_shared_1.uniqueStrings)([...(0, typed_memory_shared_1.tokens)(raw), ...(0, typed_memory_shared_1.tokens)(canonical)], 260);
    ...
    const signature = concepts.length >= 2 && constraintLike && (directivePolarities.length > 0 || relations.length > 0)
        ? (0, typed_memory_shared_1.checksum)([concepts.slice().sort(), directivePolarities.slice().sort(), relations.slice().sort(), constraintLike], 24)
        : "";
    return {
        raw,
        canonical,
...
function scoreSemanticNaturalLanguageRecall(doc, stats) {
    ...
    const sentenceMatches = (features.sentences || []).map((sentence) => {
        ...
        return { sentence: (0, typed_memory_shared_1.compactText)(sentence, 180), concepts, count: concepts.length };
...
function semanticRecallDuplicateOf(candidate, accepted = []) {
    ...
    for (const existing of accepted) {
        ...
        if (sameType && directivePresent && directiveCompatible && sharedConcepts.length >= 4 && conceptCoverage >= 0.8)
            return existing;
        const existingTokens = new Set((0, typed_memory_shared_1.tokens)(`${existing.name || ""}\n${existing.description || ""}\n${existing.body || ""}`));
        const candidateTokens = new Set((0, typed_memory_shared_1.tokens)(`${candidate.name || ""}\n${candidate.description || ""}\n${candidate.body || ""}`));
...
function extractSemanticRecallSnippet(body, queryFeatures, max = 700) {
    ...
    return (0, typed_memory_shared_1.compactText)(picked, max);
}
...
function normalizeWorkerContextPressureRecallSignals(options = {}) {
    ...
    const signals = sources.map(({ source, raw }) => {
        ...
        const pressure = (0, typed_memory_shared_1.firstFiniteNumber)(raw.pressure, raw.worker_context_packet_pressure, raw.context_pressure, raw.contextPressure);
        const totalTokens = (0, typed_memory_shared_1.firstFiniteNumber)(raw.total_tokens, raw.totalTokens, raw.worker_context_packet_total_tokens);
        const maxTokens = (0, typed_memory_shared_1.firstFiniteNumber)(raw.max_tokens, raw.maxTokens, raw.worker_context_packet_max_tokens);
        const autocompactBufferTokens = (0, typed_memory_shared_1.firstFiniteNumber)(raw.autocompact_buffer_tokens, raw.autocompactBufferTokens, raw.worker_context_packet_autocompact_buffer_tokens);
        const computedFreeTokens = maxTokens > 0 ? maxTokens - totalTokens - autocompactBufferTokens : 0;
        const freeTokens = (0, typed_memory_shared_1.firstFiniteNumber)(raw.free_tokens, raw.freeTokens, raw.worker_context_packet_free_tokens, computedFreeTokens);
        ...
        const blockedOutcomeCount = (0, typed_memory_shared_1.firstFiniteNumber)(raw.blocked_outcome_count, raw.blockedOutcomeCount, raw.blocked_count, raw.blockedCount);
        const taskCompactedBlockedCount = (0, typed_memory_shared_1.firstFiniteNumber)(raw.task_compacted_blocked_count, raw.taskCompactedBlockedCount);
        ...
        return {
            ...
            reason: (0, typed_memory_shared_1.compactText)(raw.reason || raw.recommendation || raw.next_step || raw.nextStep || raw.method || "", 260),
        };
...
function classifyWorkerContextPressureRecallDoc(corpus, doc = {}) {
    ...
    return {
        ...
        kinds,
        matched_keywords: (0, typed_memory_shared_1.uniqueStrings)(matchedKeywords, 12),
    };
}
...
function normalizeWorkerContextPressureRecallUsageAging(options = {}) {
    ...
    const halfLifeDays = Math.max(1, Number(options.usageHalfLifeDays
        ...
        ?? typed_memory_shared_1.GROUP_TYPED_MEMORY_PRESSURE_RECALL_USAGE_HALF_LIFE_DAYS));
    const staleAfterDays = Math.max(halfLifeDays, Number(options.usageStaleAfterDays
        ...
        ?? typed_memory_shared_1.GROUP_TYPED_MEMORY_PRESSURE_RECALL_USAGE_STALE_AFTER_DAYS));
...
function workerContextPressureRecallUsageDecayWeight(ageDays, aging = {}) {
    ...
    const halfLifeDays = Math.max(1, Number(aging.half_life_days || typed_memory_shared_1.GROUP_TYPED_MEMORY_PRESSURE_RECALL_USAGE_HALF_LIFE_DAYS));
...
function workerContextPressureRecallStatsKey(row = {}, targetProject = "") {
    ...
    return [
        ...
        relPath || (0, typed_memory_shared_1.checksum)(name || row.source || row.value || "pressure-memory", 18),
    ].join("|");
}
...
function buildWorkerContextPressureRecallUsageEntry(groupId, input = {}, row = {}) {
    ...
    const name = (0, typed_memory_shared_1.compactText)(row.name || row.title || "", 180);
    if (!relPath && !name)
        return null;
    ...
    const generatedAt = String(input.generatedAt || input.generated_at || row.generated_at || row.generatedAt || (0, typed_memory_shared_1.now)());
    const entryCore = {
        group_id: groupId,
        ...
        kinds: (0, typed_memory_shared_1.uniqueStrings)(Array.isArray(row.kinds) ? row.kinds : [], 8),
        ...
        reason: (0, typed_memory_shared_1.compactText)(row.reason || row.note || "", 500),
        generated_at: generatedAt,
    };
    return {
        schema: "ccm-group-typed-memory-pressure-recall-usage-entry-v1",
        entry_id: `tmpru_${(0, typed_memory_shared_1.checksum)(entryCore, 18)}`,
        ...entryCore,
    };
}
...
function normalizeWorkerContextPressureRecallUsageRepairHints(groupId, options = {}) {
    ...
    return (Array.isArray(rawItems) ? rawItems : [])
        ...
        return {
            ...
            reason: (0, typed_memory_shared_1.compactText)(item.cross_group_pressure_recall_usage_reason || item.reason || item.description || "", 420),
...
function normalizeWorkerContextPressureRecallUsageStatsRow(row = {}, aging = {}) {
    ...
    clone.stale_count = ageDays >= Number(aging.stale_after_days || typed_memory_shared_1.GROUP_TYPED_MEMORY_PRESSURE_RECALL_USAGE_STALE_AFTER_DAYS) ? Number(clone.total_count || 0) : 0;
...
function buildWorkerContextPressureRecallUsageStatsRowsFromEntries(entries = [], aging = {}) {
    ...
    for (const entry of Array.isArray(entries) ? entries : []) {
        ...
        current.kinds = (0, typed_memory_shared_1.uniqueStrings)([...(Array.isArray(current.kinds) ? current.kinds : []), ...(Array.isArray(entry.kinds) ? entry.kinds : [])], 12);
        ...
        if (ageDays >= Number(aging.stale_after_days || typed_memory_shared_1.GROUP_TYPED_MEMORY_PRESSURE_RECALL_USAGE_STALE_AFTER_DAYS))
        ...
        current.agents = (0, typed_memory_shared_1.uniqueStrings)([...(Array.isArray(current.agents) ? current.agents : []), entry.agent].filter(Boolean), 12);
        current.task_ids = (0, typed_memory_shared_1.uniqueStrings)([...(Array.isArray(current.task_ids) ? current.task_ids : []), entry.task_id || entry.taskId].filter(Boolean), 12);
        current.packet_ids = (0, typed_memory_shared_1.uniqueStrings)([...(Array.isArray(current.packet_ids) ? current.packet_ids : []), entry.worker_context_packet_id || entry.workerContextPacketId].filter(Boolean), 12);
        current.group_ids = (0, typed_memory_shared_1.uniqueStrings)([...(Array.isArray(current.group_ids) ? current.group_ids : []), entry.group_id || entry.groupId].filter(Boolean), 24);
        current.provenance_statuses = (0, typed_memory_shared_1.uniqueStrings)([...(Array.isArray(current.provenance_statuses) ? current.provenance_statuses : []), entry.provenance_status || entry.provenanceStatus].filter(Boolean), 12);
        current.repair_work_item_ids = (0, typed_memory_shared_1.uniqueStrings)([...(Array.isArray(current.repair_work_item_ids) ? current.repair_work_item_ids : []), entry.repair_work_item_id || entry.repairWorkItemId].filter(Boolean), 12);
        current.repair_statuses = (0, typed_memory_shared_1.uniqueStrings)([...(Array.isArray(current.repair_statuses) ? current.repair_statuses : []), entry.repair_status || entry.repairStatus].filter(Boolean), 12);
        current.repair_gap_types = (0, typed_memory_shared_1.uniqueStrings)([...(Array.isArray(current.repair_gap_types) ? current.repair_gap_types : []), entry.repair_gap_type || entry.repairGapType].filter(Boolean), 12);
...
function normalizeWorkerContextPressureRecallUsageHints(groupId, options = {}) {
    ...
    return rows.map((row) => {
        ...
        const normalized = {
            ...
            group_ids: (0, typed_memory_shared_1.uniqueStrings)(Array.isArray(row.group_ids || row.groupIds) ? (row.group_ids || row.groupIds) : [], 24),
...
function pressureProvenancePreDispatchComplianceRowId(row = {}) {
    return `pressure-provenance-pre-dispatch-compliance:${(0, typed_memory_shared_1.checksum)([
        row.groupId,
        row.packet_id,
        row.binding_id,
        row.project,
...
function normalizePressureProvenancePreDispatchComplianceRows(input = {}, options = {}) {
    ...
    return pressureProvenancePreDispatchComplianceInputRows(input).map((raw, index) => {
        ...
        const gapCodes = (0, typed_memory_shared_1.uniqueStrings)(gaps.map((gap) => typeof gap === "string" ? gap : gap?.code || gap?.reason || gap?.type || gap?.severity || "").filter(Boolean), 24);
        const docs = [
        ...
        const relPaths = (0, typed_memory_shared_1.uniqueStrings)([
        ...
        const repairIds = (0, typed_memory_shared_1.uniqueStrings)([
        ...
        const row = {
            ...
            version: typed_memory_shared_1.GROUP_PRESSURE_PROVENANCE_PRE_DISPATCH_COMPLIANCE_DISTILLATION_VERSION,
            ...
            reason: (0, typed_memory_shared_1.compactText)(entry.reason || raw?.reason || gapCodes.join("; ") || "pressure provenance pre-dispatch compliance gap", 1000),
...
function renderPressureProvenancePreDispatchComplianceBody(archive = {}, options = {}) {
    ...
    const lines = [
        ...
        "",
        `Generated by CCM pressure provenance pre-dispatch compliance distillation at ${options.updatedAt || (0, typed_memory_shared_1.now)()}.`,
...
function pressureProvenancePreDispatchComplianceRecoveryRowId(row = {}) {
    return `pressure-provenance-compliance-recovery:${(0, typed_memory_shared_1.checksum)([
        row.groupId,
        row.packet_id,
        row.binding_id,
        row.project,
...
function normalizePressureProvenancePreDispatchComplianceRecoveryRows(input = {}, options = {}) {
    ...
    return pressureProvenancePreDispatchComplianceInputRows(input).map((raw, index) => {
        ...
        const row = {
            ...
            rel_paths: relPaths,
            repair_work_item_ids: repairIds,
            reason: (0, typed_memory_shared_1.compactText)(entry.reason || raw?.reason || "pressure provenance receipt compliant after prior feedback policy", 1000),
            first_seen_at: String(entry.first_seen_at || entry.createdAt || entry.created_at || entry.at || raw?.first_seen_at || raw?.at || options.updatedAt || (0, typed_memory_shared_1.now)()),
            last_seen_at: String(entry.updated_at || entry.updatedAt || entry.lastSeenAt || entry.at || raw?.updated_at || raw?.at || options.updatedAt || (0, typed_memory_shared_1.now)()),
            source_index: Number(raw?.source_index || raw?.sourceIndex || index),
        };
...
function renderPressureProvenancePreDispatchComplianceRecoveryBody(archive = {}, options = {}) {
    ...
    const lines = [
        ...
        "",
        `Generated by CCM pressure provenance compliance recovery distillation at ${options.updatedAt || (0, typed_memory_shared_1.now)()}.`,
...
function buildPressureProvenancePreDispatchComplianceDispatchPolicy(groupId, options = {}) {
    ...
    const generatedAt = String(options.generatedAt || options.generated_at || (0, typed_memory_shared_1.now)());
    ...
    const crossGroupProviderReliabilitySignal = crossGroupProviderReliabilityDisabled
        ? null
        : (0, typed_memory_distillation_receipts_1.buildCrossGroupProviderDispatchReliabilitySignal)(groupId, {
            ...options,
            agentType,
            generatedAt,
    ...
    const violationPolicyRows = attributions
        ...
        const providerOverrideFollowup = (0, typed_memory_distillation_receipts_1.summarizeProviderDispatchOverrideFollowupPolicyAttributions)(providerOverrideFollowupMatches);
        ...
        return {
            ...
            rel_paths: (0, typed_memory_shared_1.uniqueStrings)(Array.isArray(row.rel_paths) ? row.rel_paths : [], 12),
            repair_work_item_ids: (0, typed_memory_shared_1.uniqueStrings)(Array.isArray(row.repair_work_item_ids) ? row.repair_work_item_ids : [], 12),
            gap_codes: (0, typed_memory_shared_1.uniqueStrings)(Array.isArray(row.gap_codes) ? row.gap_codes : [], 12),
    ...
    const providerOverrideFollowupOnlyRows = matchingProviderOverrideFollowupAttributions
        ...
        .map((row) => {
        const providerOverrideFollowup = (0, typed_memory_distillation_receipts_1.summarizeProviderDispatchOverrideFollowupPolicyAttributions)([row]);
        return {
    ...
    const providerSwitchExecutionOnlyRows = matchingProviderSwitchExecutionAttributions
        ...
        .map((row) => {
        const execution = (0, typed_memory_distillation_receipts_1.summarizeProviderSwitchExecutionPolicyAttributions)([row]);
        return {
    ...
    const matching = [...localPolicyRows, ...crossGroupProviderReliabilityOnlyRows]
        ...
        const validation = (0, typed_memory_distillation_receipts_1.summarizeProviderDispatchOverrideFollowupReceiptValidationPolicyAttributions)(validationMatches);
        ...
        const localValidationRisk = (0, typed_memory_distillation_receipts_1.scoreProviderDispatchReliabilityRows)(providerOverrideFollowupReceiptValidationRows.filter((candidate) => pressureProvenanceDispatchPolicyAttributionMatches(candidate, {
            targetProject: row.project || row.target_project || row.targetProject || targetProject,
            agentType: row.agent_type || row.agentType || agentType,
        })), {
            ...options,
        ...
        const providerSwitchExecution = (0, typed_memory_distillation_receipts_1.summarizeProviderSwitchExecutionPolicyAttributions)(providerSwitchExecutionMatches);
        const providerSwitchExecutionEvidenceRows = providerSwitchExecutionRows
            .filter((candidate) => pressureProvenanceDispatchPolicyAttributionMatches(candidate, {
            targetProject: row.project || row.target_project || row.targetProject || targetProject,
            agentType: row.agent_type || row.agentType || agentType,
        }));
        const providerSwitchExecutionRisk = (0, typed_memory_distillation_receipts_1.scoreProviderSwitchExecutionRows)(providerSwitchExecutionEvidenceRows, {
            ...options,
            generatedAt,
        });
        const providerSwitchExecutionRowIds = (0, typed_memory_shared_1.uniqueStrings)([
        ...
        const providerSwitchExecutionMemoryRelPaths = providerSwitchExecution.executedCount > 0 || providerSwitchExecutionEvidenceRows.length
            ? (0, typed_memory_shared_1.uniqueStrings)([
        ...
        return {
            ...
            provider_override_followup_rel_paths: (0, typed_memory_shared_1.uniqueStrings)([
                ...(Array.isArray(row.provider_override_followup_rel_paths) ? row.provider_override_followup_rel_paths : []),
                ...validation.relPaths,
            ], 16),
            provider_override_followup_work_item_ids: (0, typed_memory_shared_1.uniqueStrings)([
            ...
            provider_override_followup_override_ids: (0, typed_memory_shared_1.uniqueStrings)([
    ...
    return {
        ...
        sourceLedgerFile: ledger.file || (0, typed_memory_distillation_receipts_1.getGroupTypedMemoryDistillationLedgerFile)(groupId),
        ...
        providerSwitchExecutionDecayedMismatchScore: (0, typed_memory_distillation_receipts_1.providerDispatchReliabilityRound)(matching.reduce((sum, row) => sum + Number(row.provider_switch_execution_decayed_mismatch_score || 0), 0)),
        providerSwitchExecutionDecayedFailedScore: (0, typed_memory_distillation_receipts_1.providerDispatchReliabilityRound)(matching.reduce((sum, row) => sum + Number(row.provider_switch_execution_decayed_failed_score || 0), 0)),
        providerSwitchExecutionDecayedPassedScore: (0, typed_memory_distillation_receipts_1.providerDispatchReliabilityRound)(matching.reduce((sum, row) => sum + Number(row.provider_switch_execution_decayed_passed_score || 0), 0)),
        providerSwitchExecutionWeightedRiskScore: (0, typed_memory_distillation_receipts_1.providerDispatchReliabilityRound)(matching.reduce((sum, row) => sum + Number(row.provider_switch_execution_weighted_risk_score || 0), 0)),
        ...
        requiredReceiptFields: active
            ...
            : [],
        policyRows,
        relPaths: (0, typed_memory_shared_1.uniqueStrings)(policyRows.flatMap((row) => [
        ...
        repairWorkItemIds: (0, typed_memory_shared_1.uniqueStrings)(policyRows.flatMap((row) => [
        ...
        gapCodes: (0, typed_memory_shared_1.uniqueStrings)(policyRows.flatMap((row) => [
        ...
        reason: active
            ? top.provider_switch_execution_mismatch_escalated === true
                ? (0, typed_memory_shared_1.compactText)(`Provider switch execution typed memory found ${top.provider_switch_execution_mismatch_count || 0} mismatch(es) for expected provider=${agentType} project=${targetProject || "unknown"}; hold new approved switches for this provider/project until runner/session binding repair is verified.`, 700)
                : top.provider_override_followup_receipt_validation_escalated === true
                    ? (0, typed_memory_shared_1.compactText)(`Corrected provider override follow-up receipts failed ${top.provider_override_followup_receipt_validation_consecutive_failure_count || 0} consecutive validation attempt(s) for agentType=${agentType} project=${targetProject || "unknown"}; hold new child Agent dispatch until a receipt satisfies the full relPath/work-item/override-id/current-source contract.`, 700)
                    : (0, typed_memory_shared_1.compactText)(`Phase 137 feedback memory found repeated pressure provenance receipt violations for agentType=${agentType} project=${targetProject || "unknown"}; effective violations=${top.effective_violation_count ?? top.violation_count ?? 0} after recovery credits${top.relapsed ? `; recovered attribution relapsed with ${top.post_recovery_violation_count || 0} post-recovery violation(s)` : ""}; require stricter ACK and final receipt verification before child Agent closure.`, 700)
            : disabled
...
function normalizeRecallScope(value) {
    return (0, typed_memory_shared_1.safeSegment)(value || "global", "global");
}
...
function recordGroupTypedMemoryRecallUnlocked(groupId, scope, recall, query = "", options = {}) {
    if (options.disableLedger === true || options.disable_ledger === true || recall?.ignored)
        return (0, typed_memory_ledgers_1.readGroupTypedMemoryRecallLedger)(groupId);
    ...
    const at = (0, typed_memory_shared_1.now)();
    if (deliveryLease) {
        ...
        const leaseValid = deliveryLease.schema === "ccm-child-typed-memory-delivery-lease-v1"
            ...
            && !!leaseId
            && !!leaseChecksum
            && leaseChecksum === (0, typed_memory_shared_1.typedMemoryDeliveryLeaseChecksum)(deliveryLease)
    ...
    for (const relPath of surfaced) {
        ...
        scoped.docs[docKey] = {
            ...
            lastQueryHash: (0, typed_memory_shared_1.checksum)(String(query || ""), 16),
        };
    }
    ...
    if (deliveryLease) {
        ...
        scoped.deliveryLeases = Object.fromEntries(Object.entries(scoped.deliveryLeases)
            ...
            .slice(-typed_memory_shared_1.GROUP_TYPED_MEMORY_RECALL_LEDGER_MAX_DELIVERY_LEASES_PER_SCOPE));
    }
    ledger.scopes[key] = scoped;
    ledger.scopes = Object.fromEntries(Object.entries(ledger.scopes)
        ...
        .slice(-typed_memory_shared_1.GROUP_TYPED_MEMORY_RECALL_LEDGER_MAX_SCOPES));
    ledger.updatedAt = at;
    (0, typed_memory_shared_1.writeJsonAtomic)(ledger.file, {
        schema: "ccm-group-typed-memory-recall-ledger-v1",
        version: 3,
...
function typedMemoryStaleCandidateRejection(scopeId, row, codes, at) {
    const payload = {
        ...
        version: 1,
        rejection_id: `tmsr_${(0, typed_memory_shared_1.checksum)([scopeId, row.task_id || row.taskId || "", row.execution_id || row.executionId || "", row.task_agent_session_id || row.taskAgentSessionId || "", row.rel_path || row.relPath || "", row.recommended_memory_action || row.recommendedMemoryAction || "", codes], 28)}`,
        scope_id: scopeId,
        ...
        rejection_codes: (0, typed_memory_shared_1.uniqueStrings)(codes).slice(0, 16),
        rejected_at: at,
    };
    return { ...payload, checksum: (0, typed_memory_shared_1.typedMemoryStaleRejectionChecksum)(payload) };
}
function recordGroupTypedMemoryStaleCandidates(groupId, input = {}) {
    ...
    const ledger = (0, typed_memory_ledgers_1.readGroupTypedMemoryStaleCandidateLedger)(scopeId);
    ...
    const docs = new Map((0, typed_memory_index_build_1.scanGroupTypedMemoryDocumentsRaw)(scopeId).map((doc) => [String(doc.relPath || "").toLowerCase(), doc]));
    ...
    for (const row of rows) {
        ...
        const conflictReason = (0, typed_memory_shared_1.compactText)(row.conflict_reason || row.conflictReason || "", 1200);
        const replacementMemory = (0, typed_memory_shared_1.compactText)(row.replacement_memory || row.replacementMemory || "", 12_000);
        ...
        const candidateId = `tmsc_${(0, typed_memory_shared_1.checksum)([
            scopeId,
        ...
        const payload = {
            ...
            memory_name: (0, typed_memory_shared_1.compactText)(currentDoc.name || "", 180),
            memory_type: (0, typed_memory_shared_1.normalizeMemoryType)(currentDoc.type),
    ...
    const next = (0, typed_memory_ledgers_1.writeGroupTypedMemoryStaleCandidateLedger)(scopeId, {
        candidates,
...
function resolveGroupTypedMemoryStaleCandidate(groupId, input = {}) {
    ...
    const reason = (0, typed_memory_shared_1.compactText)(input.reason || "", 800);
    if (!reason)
    ...
    if (requestedAction !== "reject") {
        const doc = (0, typed_memory_index_build_1.scanGroupTypedMemoryDocumentsRaw)(scopeId).find((item) => String(item.relPath || "").toLowerCase() === String(candidate.rel_path || "").toLowerCase());
        ...
        if (action === "update") {
            const write = (0, typed_memory_index_build_1.upsertGroupTypedMemoryDocument)(scopeId, {
            ...
            replacementDocumentChecksum = String((0, typed_memory_index_build_1.scanGroupTypedMemoryDocumentsRaw)(scopeId)
    ...
    const eventPayload = {
        ...
        version: 1,
        event_id: `tmse_${(0, typed_memory_shared_1.checksum)([scopeId, candidateId, requestedAction, candidateChecksum, at], 28)}`,
        candidate_id: candidateId,
    ...
    const event = { ...eventPayload, checksum: (0, typed_memory_shared_1.typedMemoryStaleResolutionChecksum)(eventPayload) };
    ...
    if (event.status === "applied")
        (0, typed_memory_index_build_1.buildGroupTypedMemoryIndex)(scopeId);
...
//# sourceMappingURL=typed-memory-recall.js.map