...
function runGroupTypedMemoryDistillationMutationCoordinatorSelfTest() {
    ...
    try {
        const result = (0, group_memory_index_1.runGroupTypedMemoryDistillationMutation)(groupId, "phase272_outer", {}, outer => {
            const nested = (0, group_memory_index_1.runGroupTypedMemoryDistillationMutation)(groupId, "phase272_inner", {}, inner => {
                ...
                (0, group_memory_index_1.writeJsonAtomic)(ledger.file, {
                    ...
                    coordinatorSelfTestArchive: {
                        ...
                        updatedAt: (0, group_memory_index_1.now)(),
                    },
                    updatedAt: (0, group_memory_index_1.now)(),
                });
                return {
        ...
        const ledger = (0, group_memory_index_1.readGroupTypedMemoryDistillationLedger)(groupId);
        const state = (0, group_memory_index_1.readGroupTypedMemoryDistillationTransactionState)(groupId);
        let failClosed = false;
        try {
            (0, group_memory_index_1.writeJsonAtomic)(ledger.file, { schema: "invalid-uncoordinated-selftest", groupId });
        }
        catch (error) {
        ...
        const checks = {
            ...
            lockReleased: (0, group_memory_index_1.inspectGroupTypedMemoryDistillationLock)(groupId).present === false,
...
function runGroupTypedMemoryIndexSelfTest() {
    ...
    const dir = (0, group_memory_index_1.getGroupTypedMemoryDir)(groupId);
    try {
        const sync = (0, group_memory_index_1.syncGroupTypedMemoryFromGroupMemory)(groupId, {
        ...
        const recall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "支付回调 IDEMPOTENCY_TYPED_SENTINEL src/pay.ts npm run check", {});
        const ledgerBefore = (0, group_memory_index_1.getAlreadySurfacedGroupTypedMemory)(groupId, "api");
        (0, group_memory_index_1.recordGroupTypedMemoryRecall)(groupId, "api", recall, "支付回调 IDEMPOTENCY_TYPED_SENTINEL");
        const ledgerAfter = (0, group_memory_index_1.getAlreadySurfacedGroupTypedMemory)(groupId, "api");
        const deduped = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "支付回调 IDEMPOTENCY_TYPED_SENTINEL src/pay.ts npm run check", { alreadySurfaced: ledgerAfter });
        const ignored = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "本轮请忽略记忆，只看当前任务", {});
...
function runGroupTypedMemoryPostCompactUsageScoringSelfTest() {
    ...
    try {
        ...
        const recall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续恢复候选任务", {
            max: 5,
...
function runGroupTypedMemoryWorkerContextPressureRecallSelfTest() {
    ...
    try {
        ...
        const noPressure = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, query, { max: 6 });
        const pressure = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, query, {
            max: 6,
        ...
        const ptl = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, query, {
            max: 6,
            ptlEmergency: {
                engaged: true,
        ...
        const usageSummary = (0, group_memory_index_1.buildGroupTypedMemoryPressureRecallUsageSummary)(groupId, { targetProject: "api" });
        const staleUsageRecord = (0, group_memory_index_1.recordGroupTypedMemoryPressureRecallUsageLedger)(groupId, {
            targetProject: "api",
        ...
        const staleUsageSummary = (0, group_memory_index_1.buildGroupTypedMemoryPressureRecallUsageSummary)(groupId, {
            targetProject: "api",
            nowMs: Date.parse("2026-07-09T00:00:00.000Z"),
        });
        const pressureAfterUsage = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, query, {
            max: 6,
            targetProject: "api",
            nowMs: Date.parse("2026-07-09T00:00:00.000Z"),
            workerContextPacketContextUsage: {
        ...
        const pressureAfterStaleUsage = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "PRESSURE_STALE_USAGE_SENTINEL worker context over_budget", {
            max: 8,
            targetProject: "api",
            nowMs: Date.parse("2026-07-09T00:00:00.000Z"),
            workerContextPacketContextUsage: {
        ...
        const rendered = (0, group_memory_index_1.renderGroupTypedMemoryRecall)(pressure);
...
function runGroupTypedMemoryCrossGroupPressureRecallUsageSelfTest() {
    ...
    const dirs = [(0, group_memory_index_1.getGroupTypedMemoryDir)(sourceGroupId), (0, group_memory_index_1.getGroupTypedMemoryDir)(targetGroupId)];
    ...
    const findDoc = (recall, relPath) => (recall.recalled || []).find((item) => item.relPath === relPath)
        ...
        || {};
    try {
        (0, group_memory_index_1.upsertGroupTypedMemoryDocument)(targetGroupId, {
            type: "feedback",
            slug: "worker-context-usage-pressure-discipline",
            name: "WorkerContextPacket context usage pressure discipline",
        ...
        const crossSummary = (0, group_memory_index_1.buildGroupTypedMemoryPressureRecallUsageProjectSummary)(targetGroupId, {
            targetProject: "api",
            groupIds: [sourceGroupId],
            nowMs,
        });
        const crossRecall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(targetGroupId, "继续普通项目任务 NORMAL_CROSS_GROUP_PRESSURE_SENTINEL", {
            max: 8,
            targetProject: "api",
            nowMs,
        ...
        const wrongProjectRecall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(targetGroupId, "继续普通项目任务 NORMAL_CROSS_GROUP_PRESSURE_SENTINEL", {
            max: 8,
            targetProject: "web",
            nowMs,
            workerContextPacketContextUsage: pressureUsage,
        ...
        const localRecord = (0, group_memory_index_1.recordGroupTypedMemoryPressureRecallUsageLedger)(targetGroupId, {
            targetProject: "api",
        ...
        const localOverrideRecall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(targetGroupId, "继续普通项目任务 NORMAL_CROSS_GROUP_PRESSURE_SENTINEL", {
            max: 8,
            targetProject: "api",
            nowMs,
            workerContextPacketContextUsage: pressureUsage,
...
function runGroupTypedMemoryPressureRecallUsageRepairProvenanceSelfTest() {
    ...
    const repairFile = (0, group_memory_index_1.getGroupPressureRecallUsageRepairWorkItemsFile)(groupId);
    ...
    try {
        ...
        (0, group_memory_index_1.writeJsonAtomic)(repairFile, {
        ...
        const recall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 WorkerContextPacket over_budget PRESSURE_REPAIR_PROVENANCE_SENTINEL", {
            max: 6,
            targetProject,
            nowMs,
            workerContextPacketContextUsage: {
...
function runGroupTypedMemoryLoadPlanSelfTest() {
    ...
    try {
        ...
        const plan = (0, group_memory_index_1.buildGroupTypedMemoryLoadPlan)(groupId, {});
        const rendered = (0, group_memory_index_1.renderGroupTypedMemoryLoadPlan)(plan);
        ...
        const checks = {
            ...
            entrypointFirst: entries[0]?.relPath === group_memory_index_1.GROUP_TYPED_MEMORY_ENTRYPOINT && entries[0]?.kind === "entrypoint",
...
function runGroupTypedMemoryPathConditionSelfTest() {
    ...
    try {
        ...
        const payRecall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 src/pay.ts 支付回调 PATH_CONDITION_PAY_SENTINEL", { max: 8 });
        const searchRecall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 src/search/index.ts 搜索索引 PATH_CONDITION_SEARCH_SENTINEL", { max: 8 });
        const unrelatedRecall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 docs/readme.md 文档任务 PATH_CONDITION", { max: 8 });
        const payPlan = (0, group_memory_index_1.buildGroupTypedMemoryLoadPlan)(groupId, { targetPaths: ["src/pay.ts"] });
        const unrelatedPlan = (0, group_memory_index_1.buildGroupTypedMemoryLoadPlan)(groupId, { targetPaths: ["docs/readme.md"] });
        const rendered = (0, group_memory_index_1.renderGroupTypedMemoryRecall)(payRecall);
...
function runGroupProjectMemoryImportSelfTest() {
    ...
    try {
        ...
        const discovery = (0, group_memory_index_1.discoverProjectMemoryFiles)(projectRoot, {});
        const imported = (0, group_memory_index_1.importProjectMemoryFilesToGroupTypedMemory)(groupId, projectRoot, { project: "api" });
        const recall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 src/pay.ts PROJECT_MEMORY_IMPORT_PAY_RULE_SENTINEL", { max: 10 });
        const includeRecall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 PROJECT_MEMORY_IMPORT_INCLUDE_SENTINEL", { max: 10 });
        const unrelated = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 docs/readme.md PROJECT_MEMORY_IMPORT_PAY_RULE_SENTINEL", { max: 10 });
        const plan = (0, group_memory_index_1.buildGroupTypedMemoryLoadPlan)(groupId, { targetPaths: ["src/pay.ts"] });
...
function runGroupGlobalClaudeMemoryImportSelfTest() {
    ...
    try {
        ...
        const discovery = (0, group_memory_index_1.discoverGlobalClaudeMemoryFiles)({ userRoot, managedRoot });
        const imported = (0, group_memory_index_1.importGlobalClaudeMemoryToGroupTypedMemory)(groupId, { userRoot, managedRoot });
        const recall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 src/pay.ts GLOBAL_CLAUDE_USER_PAY_RULE_SENTINEL", { max: 10 });
        const includeRecall = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 GLOBAL_CLAUDE_USER_INCLUDE_SENTINEL", { max: 10 });
        const unrelated = (0, group_memory_index_1.buildGroupTypedMemoryRecall)(groupId, "继续 docs/readme.md GLOBAL_CLAUDE_USER_PAY_RULE_SENTINEL", { max: 10 });
        const docs = (0, group_memory_index_1.scanGroupTypedMemoryDocuments)(groupId);
        const indexText = fs.readFileSync((0, group_memory_index_1.getGroupTypedMemoryIndexFile)(groupId), "utf-8");
        const checks = {
...
//# sourceMappingURL=group-memory-recall-self-tests.js.map