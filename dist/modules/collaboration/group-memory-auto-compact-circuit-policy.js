...
exports.GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_MAX_BACKOFF_STEPS = exports.GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_COOLDOWN_MS = exports.GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_POLICY_VERSION = void 0;
exports.classifyAutoCompactFailure = classifyAutoCompactFailure;
exports.autoCompactCircuitCooldownMs = autoCompactCircuitCooldownMs;
exports.evaluateAutoCompactCircuitAdmission = evaluateAutoCompactCircuitAdmission;
exports.buildAutoCompactCircuitDisplayState = buildAutoCompactCircuitDisplayState;
exports.GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_POLICY_VERSION = 1;
exports.GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_COOLDOWN_MS = Math.max(30_000, Number(process.env.CCM_GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_COOLDOWN_MS || 10 * 60_000));
exports.GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_MAX_BACKOFF_STEPS = 4;
...
function autoCompactCircuitCooldownMs(openCount, cooldownMs = exports.GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_COOLDOWN_MS) {
    const steps = Math.max(0, Math.min(exports.GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_MAX_BACKOFF_STEPS, Number(openCount || 1) - 1));
 ...
 */
function evaluateAutoCompactCircuitAdmission(ledger = {}, options = {}) {
    const nowMs = Number(options.nowMs || Date.now());
    const cooldownBaseMs = Number(options.cooldownMs || exports.GROUP_MEMORY_AUTO_COMPACT_CIRCUIT_COOLDOWN_MS);
    const state = String(ledger?.state || "closed");
    const failureMode = ["transient", "structural", "cancelled"].includes(String(ledger?.failure_mode || ""))
        ? ledger.failure_mode
        : "transient";
 ...
 */
function buildAutoCompactCircuitDisplayState(input = {}) {
...
//# sourceMappingURL=group-memory-auto-compact-circuit-policy.js.map