...
exports.ACCEPTANCE_UPLOAD_FLOW_PROBE_TYPE = void 0;
exports.buildAcceptanceUploadFlows = buildAcceptanceUploadFlows;
exports.buildAcceptanceUploadFlowBrowserChecks = buildAcceptanceUploadFlowBrowserChecks;
const utils_1 = require("../utils");
exports.ACCEPTANCE_UPLOAD_FLOW_PROBE_TYPE = "acceptance_upload_flow";
...
function buildAcceptanceUploadFlows(project, acceptanceCriteria = []) {
    ...
    for (const raw of acceptanceCriteria) {
        ...
        if (!criterion || !looksLikeUploadCriterion(criterion))
            continue;
        ...
        if (!url || !fileName || !fieldLabel || !buttonName || !expectedText)
            continue;
...
function buildAcceptanceUploadFlowBrowserChecks(project, acceptanceCriteria = []) {
...
//# sourceMappingURL=acceptance-upload-flows.js.map