...
export interface BrowserActionSpec {
    type: "goto" | "click" | "fill" | "selectOption" | "check" | "uncheck" | "hover" | "press" | "scroll" | "openApplication" | "requestAccess" | "reload" | "goBack" | "goForward" | "waitForSelector" | "waitForText" | "waitForTimeout" | "evaluate";
    selector?: string;
    locator?: string;
    text?: string;
    value?: string;
...
export interface BrowserAssertionSpec {
    type: "visible" | "notVisible" | "text" | "urlIncludes" | "titleIncludes" | "elementTextIncludes" | "networkNoErrors" | "consoleNoErrors" | "jsTruthy" | "jsEquals" | "localStorageEquals" | "localStorageIncludes" | "sessionStorageEquals" | "sessionStorageIncludes";
    selector?: string;
    locator?: string;
    text?: string;
    value?: string;
...
export interface TestAgentArtifactManifestItem {
    type: "report_json" | "report_markdown" | "artifact_manifest" | "screenshot" | "browser_snapshot" | "browser_console_log" | "browser_network_log" | "browser_tool_transcript" | "browser_trace" | "browser_har" | "browser_video" | "browser_artifact" | "evidence_artifact";
    title: string;
    path: string;
    project?: string;
