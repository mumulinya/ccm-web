...
export type TestAgentRequiredCheck = "commands" | "build" | "unit_tests" | "browser_e2e" | "console_errors" | "screenshots" | string;
...
export interface TestAgentBrowserToolExecutor {
    ...
    callTool: (toolName: string, input: Record<string, any>, options?: {
        signal?: AbortSignal;
        timeoutMs?: number;
    }) => Promise<any>;
}
...
export type HttpConcurrencyAssertionType = "responseCount" | "statusCount" | "jsonPathUniqueCount" | "jsonPathAllEqual";
...
export interface BrowserActionSpec {
    type: "goto" | "click" | "doubleClick" | "rightClick" | "fill" | "selectOption" | "check" | "uncheck" | "uploadFile" | "dragTo" | "setClipboard" | "setCookie" | "clearCookies" | "setLocalStorage" | "setSessionStorage" | "clearStorage" | "setOffline" | "setOnline" | "hover" | "focus" | "typeText" | "press" | "scroll" | "openApplication" | "requestAccess" | "reload" | "goBack" | "goForward" | "waitForSelector" | "waitForText" | "waitForUrl" | "waitForTimeout" | "evaluate";
    selector?: string;
    locator?: string;
    text?: string;
    value?: string;
...
export type BrowserActionEffectSignal = "url" | "title" | "page_text" | "dom" | "network" | "dialog" | "popup" | "download";
...
export type BrowserRecoveryTrigger = "stale_tab" | "navigation_context_lost" | "transport_disconnected";
...
export type HttpPageResourceKind = "script" | "stylesheet" | "image" | "font" | "media" | "document" | "manifest" | "other";
...
export type AcceptanceEvidenceGateStatus = "verified" | "failed" | "incomplete" | "weak" | "not_applicable";
