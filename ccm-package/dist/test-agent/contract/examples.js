...
exports.TEST_AGENT_HANDOFF_EXAMPLES = exports.TEST_AGENT_WORK_ORDER_EXAMPLES = exports.TEST_AGENT_WEB_APP_HANDOFF_EXAMPLE = exports.TEST_AGENT_MINIMAL_HANDOFF_EXAMPLE = exports.TEST_AGENT_WEB_APP_WORK_ORDER_EXAMPLE = exports.TEST_AGENT_MINIMAL_WORK_ORDER_EXAMPLE = void 0;
...
exports.TEST_AGENT_MINIMAL_HANDOFF_EXAMPLE = {
    taskId: "task-example",
    groupId: "group-example",
    issuedBy: "group-main-agent",
    originalUserGoal: "Verify the delivered task has executable evidence.",
...
exports.TEST_AGENT_WEB_APP_HANDOFF_EXAMPLE = {
    taskId: "task-web-login-flow",
    groupId: "group-web-project",
    issuedBy: "group-main-agent",
    originalUserGoal: "Build a web login flow and prove that users can sign in and see the dashboard.",
...
exports.TEST_AGENT_HANDOFF_EXAMPLES = {
    minimal: exports.TEST_AGENT_MINIMAL_HANDOFF_EXAMPLE,
    webApp: exports.TEST_AGENT_WEB_APP_HANDOFF_EXAMPLE,
};
