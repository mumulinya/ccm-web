...
const collaboration_agent_probes_part_01_1 = require("./collaboration-agent-probes-part-01");
...
function summarizeAgentProbeTargets(targets, probeResolver = collaboration_agent_probes_part_01_1.readAgentProbeStatus) {
    const rows = (targets || []).map((target) => {
        ...
        const candidates = runtimeCandidates.map((agentType) => {
            ...
            const candidateHealth = (0, collaboration_agent_probes_part_01_1.getAgentProbeHealth)(candidateProbe);
        ...
        const probeHealth = selected?.probeHealth || (0, collaboration_agent_probes_part_01_1.getAgentProbeHealth)(probe);
...
function enforceTaskAgentProbeReadiness(task, readiness) {
    ...
    if (!readiness.ready)
        return readiness;
    const probeHealth = readiness.probeHealth || (0, collaboration_agent_probes_part_01_1.getAgentProbeHealth)(readiness.probe);
...
function getTaskAgentExecutionReadiness(task) {
    return enforceTaskAgentProbeReadiness(task, (0, collaboration_agent_probes_part_01_1.getAgentExecutionReadiness)((0, collaboration_1.getTaskRequiredProbeTarget)(task)));
}
function buildDailyDevAgentDiagnostics() {
    ...
    const probeStatus = (0, collaboration_agent_probes_part_01_1.readAgentProbeStatus)();
    const probeHealth = (0, collaboration_agent_probes_part_01_1.getAgentProbeHealth)(probeStatus);
    const executionReadiness = (0, collaboration_agent_probes_part_01_1.getAgentExecutionReadiness)();
...
//# sourceMappingURL=collaboration-agent-probes-part-02.js.map