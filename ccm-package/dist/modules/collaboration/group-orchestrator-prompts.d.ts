...
export { GROUP_MAIN_SESSION_CONTEXT_GUIDANCE, buildGroupMainSessionGuidance } from "../../agents/main-agent-identity";
...
export declare function coordinatorNotificationStatusLabel(status: any, receiptStatus?: any): "部分完成" | "已停止" | "执行未通过" | "遇到阻塞" | "结果说明待补" | "已提交结果" | "已返回结果";
