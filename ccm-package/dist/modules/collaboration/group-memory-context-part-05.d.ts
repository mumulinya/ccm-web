export declare function buildChildParentSessionContextProjection(messagesInput: any[], memory: any, options?: any): {
    schema: string;
    version: number;
    groupId: string;
...
export declare function buildChildParentSessionContextPacket(groupId: string, options?: any): {
    schema: string;
    version: number;
    groupId: string;
    groupSessionId: string;
