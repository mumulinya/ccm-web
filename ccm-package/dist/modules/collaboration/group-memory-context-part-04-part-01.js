...
function renderGroupMemoryContextBundle(bundle) {
    ...
    const pressureMemoryProvenanceReceiptDiscipline = bundle.pressure_memory_provenance_receipt_discipline
        ...
        || (0, group_memory_context_part_01_1.buildPressureMemoryProvenanceReceiptDiscipline)({ recall: typedMemory.recall || {} }, { targetProject: bundle.target_project || "" });
    ...
    const invokedSkillAttachmentText = String(bundle.invoked_skill_attachment_text || bundle.invokedSkillAttachmentText || (0, group_memory_context_part_01_1.renderGroupPostCompactInvokedSkillAttachments)(compaction.postCompactReinject || {})).trim();
    const planAttachmentText = String(bundle.plan_attachment_text || bundle.planAttachmentText || (0, group_memory_context_part_01_1.renderGroupPostCompactPlanAttachment)(compaction.postCompactReinject || {})).trim();
    const dynamicContextDeltaText = String(bundle.dynamic_context_delta_text || bundle.dynamicContextDeltaText || (0, group_memory_context_part_01_1.renderGroupPostCompactDynamicContextDelta)(compaction.postCompactReinject || {})).trim();
...
//# sourceMappingURL=group-memory-context-part-04-part-01.js.map