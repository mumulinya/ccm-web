...
function maybeRetryWorkerContextPacketCompactionForCoordinator(baseAssignment, dependsOn, replayRepairDispatchBriefs, initialPacket, initialGate, options = {}) {
    ...
    const compactStrategyMemory = strategyMemoryDisabled ? null : (0, group_orchestrator_worker_context_part_01_1.readWorkerContextCompactStrategyMemoryForCoordinator)(groupId, groupSessionId);
    ...
    const ptlEmergencyHint = (0, group_orchestrator_worker_context_part_01_1.readWorkerContextPtlEmergencyHintForCoordinator)(groupId, groupSessionId);
    ...
    if (memoryCompact.compacted) {
        ...
        const memoryRetryBasePacket = (0, group_orchestrator_worker_context_part_01_1.buildWorkerContextPacketForAssignment)(memoryRetryAssignment, dependsOn, activeReplayRepairDispatchBriefs, memoryRetryOptions);
    ...
    if (replayBriefPartialCompact.compacted) {
        ...
        const partialRetryBasePacket = (0, group_orchestrator_worker_context_part_01_1.buildWorkerContextPacketForAssignment)(partialRetryAssignment, dependsOn, activeReplayRepairDispatchBriefs, options);
    ...
    if (metadataPartialCompact.compacted) {
        ...
        const metadataRetryBasePacket = (0, group_orchestrator_worker_context_part_01_1.buildWorkerContextPacketForAssignment)(metadataRetryAssignment, dependsOn, activeReplayRepairDispatchBriefs, options);
    ...
    const retryBasePacket = (0, group_orchestrator_worker_context_part_01_1.buildWorkerContextPacketForAssignment)(retryAssignment, dependsOn, activeReplayRepairDispatchBriefs, options);
...
function recordWorkerContextProviderSwitchSessionBindingForCoordinator(groupId, input = {}, options = {}) {
    ...
    const validation = (0, group_orchestrator_worker_context_part_01_1.validateProviderSwitchDecisionReceiptForCoordinator)(receipt, {
        ...options,
        groupId,
...
//# sourceMappingURL=group-orchestrator-worker-context-part-02.js.map