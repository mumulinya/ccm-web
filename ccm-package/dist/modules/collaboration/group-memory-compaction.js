...
exports.GROUP_FILE_UNCHANGED_STUB_PREFIX = exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_MAX_TOKENS = exports.GROUP_POST_COMPACT_LOADED_TOOL_STATE_VERSION = exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_DELTA_VERSION = exports.GROUP_POST_COMPACT_PLAN_MAX_TOKENS = exports.GROUP_POST_COMPACT_PLAN_ATTACHMENT_VERSION = exports.GROUP_POST_COMPACT_INVOKED_SKILLS_TOTAL_MAX_TOKENS = exports.GROUP_POST_COMPACT_INVOKED_SKILL_MAX_TOKENS = exports.GROUP_POST_COMPACT_INVOKED_SKILL_ATTACHMENT_VERSION = exports.GROUP_POST_COMPACT_FILE_RESTORE_DEDUP_VERSION = exports.GROUP_POST_COMPACT_TASK_STATUS_BUDGET = exports.GROUP_POST_COMPACT_TASK_STATUS_PROJECTION_VERSION = exports.GROUP_POST_COMPACT_VERIFICATION_BUDGET = exports.GROUP_POST_COMPACT_SKILL_BUDGET = exports.GROUP_POST_COMPACT_FILE_BUDGET = exports.GROUP_POST_COMPACT_CLEANUP_AUDIT_VERSION = exports.GROUP_POST_COMPACT_RECOVERY_AUDIT_VERSION = exports.GROUP_POST_COMPACT_REINJECT_VERSION = exports.GROUP_COMPACTION_SUMMARY_BINARY_MARKER = exports.GROUP_COMPACTION_SUMMARY_DOCUMENT_MARKER = exports.GROUP_COMPACTION_SUMMARY_IMAGE_MARKER = exports.GROUP_COMPACTION_SUMMARY_INPUT_PROJECTION_VERSION = exports.GROUP_TIME_BASED_THINKING_CLEARED_MESSAGE = exports.GROUP_TIME_BASED_THINKING_PROJECTION_VERSION = exports.GROUP_TIME_BASED_TOOL_RESULT_CLEARED_MESSAGE = exports.GROUP_TIME_BASED_TOOL_RESULT_PROJECTION_VERSION = exports.GROUP_TIME_BASED_MC_CLEARED_MESSAGE = exports.GROUP_TIME_BASED_MICRO_COMPACT_VERSION = exports.GROUP_API_MICROCOMPACT_CONTEXT_MANAGEMENT_BETA = exports.GROUP_API_MICROCOMPACT_DEFAULT_TARGET_INPUT_TOKENS = exports.GROUP_API_MICROCOMPACT_DEFAULT_MAX_INPUT_TOKENS = exports.GROUP_API_MICROCOMPACT_NATIVE_APPLY_PLAN_VERSION = exports.GROUP_API_MICROCOMPACT_EDIT_PLAN_VERSION = exports.GROUP_MICRO_COMPACT_MAX_RECORDS = exports.GROUP_MICRO_COMPACT_VERSION = exports.GROUP_COMPACT_MAX_ACTIVE_MESSAGES = exports.GROUP_MANUAL_COMPACT_BUFFER_TOKENS = exports.GROUP_ERROR_BUFFER_TOKENS = exports.GROUP_WARNING_BUFFER_TOKENS = exports.GROUP_AUTOCOMPACT_BUFFER_TOKENS = exports.GROUP_CONTEXT_RESERVED_TOKENS = exports.GROUP_CONTEXT_WINDOW_DEFAULT = exports.GROUP_FACT_ANCHOR_LIMIT = exports.GROUP_COMPACT_MODEL_RETRY_MS = exports.GROUP_COMPACT_MAX_FAILURES = exports.GROUP_COMPACT_MAX_KEEP_TOKENS = exports.GROUP_COMPACT_MIN_KEEP_TOKENS = exports.GROUP_COMPACT_MIN_KEEP_MESSAGES = exports.GROUP_COMPACT_TRIGGER_TOKENS = exports.GROUP_MEMORY_COMPACTION_VERSION = void 0;
exports.GROUP_COMPACTION_MODEL_INPUT_SAFETY_TOKENS = exports.GROUP_COMPACTION_MODEL_MAX_SUMMARY_TOKENS = exports.GROUP_TRUE_POST_COMPACT_PAYLOAD_VERSION = exports.GROUP_POST_COMPACT_SESSION_STATE_RESET_VERSION = exports.GROUP_SESSION_MEMORY_API_INVARIANT_CLOSURE_VERSION = exports.GROUP_SESSION_MEMORY_COMPACT_DEFAULT_MAX_TOTAL_TOKENS = exports.GROUP_SESSION_MEMORY_COMPACT_DEFAULT_MAX_SECTION_TOKENS = exports.GROUP_SESSION_MEMORY_COMPACT_PROJECTION_VERSION = exports.GROUP_SESSION_MEMORY_COMPACT_SELECTION_VERSION = exports.GROUP_COMPACTION_MODEL_USAGE_VERSION = exports.GROUP_COMPACT_LINEAGE_VERSION = exports.GROUP_POST_COMPACT_MESSAGE_ORDER_VERSION = exports.GROUP_COMPACT_TRANSACTION_RECEIPT_VERSION = exports.GROUP_COMPACTION_HOOK_LEDGER_VERSION = exports.GROUP_COMPACT_STRATEGY_DECISION_VERSION = exports.GROUP_PRESERVED_SEGMENT_VERSION = exports.GROUP_PTL_RECOVERY_VERSION = exports.GROUP_PTL_EMERGENCY_VERSION = exports.GROUP_PARTIAL_COMPACT_SEGMENT_LIMIT = exports.GROUP_PARTIAL_COMPACT_VERSION = void 0;
exports.groupPostCompactCleanupAuditChecksum = groupPostCompactCleanupAuditChecksum;
exports.verifyGroupPostCompactCleanupAudit = verifyGroupPostCompactCleanupAudit;
exports.buildGroupCompactEpoch = buildGroupCompactEpoch;
exports.buildGroupCompactLineage = buildGroupCompactLineage;
exports.verifyGroupCompactLineage = verifyGroupCompactLineage;
exports.buildGroupCompactionModelUsageReceipt = buildGroupCompactionModelUsageReceipt;
exports.verifyGroupCompactionModelUsageReceipt = verifyGroupCompactionModelUsageReceipt;
exports.buildGroupPostCompactMessageOrderReceipt = buildGroupPostCompactMessageOrderReceipt;
exports.verifyGroupPostCompactMessageOrderReceipt = verifyGroupPostCompactMessageOrderReceipt;
exports.buildGroupPostCompactSessionStateResetReceipt = buildGroupPostCompactSessionStateResetReceipt;
exports.verifyGroupPostCompactSessionStateResetReceipt = verifyGroupPostCompactSessionStateResetReceipt;
...
exports.GROUP_TIME_BASED_TOOL_RESULT_PROJECTION_VERSION = 1;
exports.GROUP_TIME_BASED_TOOL_RESULT_CLEARED_MESSAGE = "[Old tool result content cleared]";
exports.GROUP_TIME_BASED_THINKING_PROJECTION_VERSION = 1;
exports.GROUP_TIME_BASED_THINKING_CLEARED_MESSAGE = "[Old thinking content cleared]";
exports.GROUP_COMPACTION_SUMMARY_INPUT_PROJECTION_VERSION = 1;
exports.GROUP_COMPACTION_SUMMARY_IMAGE_MARKER = "[image]";
exports.GROUP_COMPACTION_SUMMARY_DOCUMENT_MARKER = "[document]";
exports.GROUP_COMPACTION_SUMMARY_BINARY_MARKER = "[binary data removed]";
exports.GROUP_POST_COMPACT_REINJECT_VERSION = 1;
exports.GROUP_POST_COMPACT_RECOVERY_AUDIT_VERSION = 1;
exports.GROUP_POST_COMPACT_CLEANUP_AUDIT_VERSION = 2;
...
exports.GROUP_POST_COMPACT_TASK_STATUS_PROJECTION_VERSION = 1;
exports.GROUP_POST_COMPACT_TASK_STATUS_BUDGET = 12;
exports.GROUP_POST_COMPACT_FILE_RESTORE_DEDUP_VERSION = 1;
exports.GROUP_POST_COMPACT_INVOKED_SKILL_ATTACHMENT_VERSION = 1;
exports.GROUP_POST_COMPACT_INVOKED_SKILL_MAX_TOKENS = 5_000;
exports.GROUP_POST_COMPACT_INVOKED_SKILLS_TOTAL_MAX_TOKENS = 25_000;
exports.GROUP_POST_COMPACT_PLAN_ATTACHMENT_VERSION = 1;
exports.GROUP_POST_COMPACT_PLAN_MAX_TOKENS = 50_000;
exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_DELTA_VERSION = 1;
exports.GROUP_POST_COMPACT_LOADED_TOOL_STATE_VERSION = 1;
exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_MAX_TOKENS = 20_000;
exports.GROUP_FILE_UNCHANGED_STUB_PREFIX = "File unchanged since last read.";
...
exports.GROUP_COMPACTION_HOOK_LEDGER_VERSION = 2;
exports.GROUP_COMPACT_TRANSACTION_RECEIPT_VERSION = 3;
exports.GROUP_POST_COMPACT_MESSAGE_ORDER_VERSION = 1;
exports.GROUP_COMPACT_LINEAGE_VERSION = 1;
exports.GROUP_COMPACTION_MODEL_USAGE_VERSION = 1;
exports.GROUP_SESSION_MEMORY_COMPACT_SELECTION_VERSION = 2;
exports.GROUP_SESSION_MEMORY_COMPACT_PROJECTION_VERSION = 1;
exports.GROUP_SESSION_MEMORY_COMPACT_DEFAULT_MAX_SECTION_TOKENS = 2_000;
exports.GROUP_SESSION_MEMORY_COMPACT_DEFAULT_MAX_TOTAL_TOKENS = 12_000;
exports.GROUP_SESSION_MEMORY_API_INVARIANT_CLOSURE_VERSION = 1;
exports.GROUP_POST_COMPACT_SESSION_STATE_RESET_VERSION = 1;
exports.GROUP_TRUE_POST_COMPACT_PAYLOAD_VERSION = 1;
...
function groupPostCompactCleanupAuditChecksum(audit) {
    const payload = { ...(audit || {}) };
    delete payload.audit_checksum;
    delete payload.checksum_valid;
    return crypto.createHash("sha256").update(JSON.stringify(payload)).digest("hex");
}
function verifyGroupPostCompactCleanupAudit(audit, expected = {}) {
    const issues = [];
    const version = Number(audit?.version || 0);
    const legacy = audit?.schema === "ccm-post-compact-cleanup-audit-v1" && version === 1;
    const current = audit?.schema === "ccm-post-compact-cleanup-audit-v2" && version === exports.GROUP_POST_COMPACT_CLEANUP_AUDIT_VERSION;
    if (!legacy && !current)
        issues.push("post_compact_cleanup_audit_schema_invalid");
    if (!String(audit?.groupId || ""))
        issues.push("post_compact_cleanup_group_missing");
    if (!String(audit?.boundaryId || ""))
        issues.push("post_compact_cleanup_boundary_missing");
    if (current) {
        if (!String(audit?.groupSessionId || "").startsWith("gcs_"))
            issues.push("post_compact_cleanup_exact_group_session_missing");
        if (String(audit?.scopeId || "") !== `${String(audit?.groupId || "")}::${String(audit?.groupSessionId || "")}`)
            issues.push("post_compact_cleanup_scope_invalid");
        if (String(audit?.compactSource?.kind || "") !== "group_main_agent")
            issues.push("post_compact_cleanup_source_invalid");
        if (audit?.compactSource?.mainThreadEquivalent !== true)
            issues.push("post_compact_cleanup_main_thread_equivalent_missing");
        if (String(audit?.compactSource?.querySource || "") !== `group_main:${String(audit?.scopeId || "")}`)
            issues.push("post_compact_cleanup_query_source_invalid");
        if (String(audit?.cleanupScope?.groupId || "") !== String(audit?.groupId || "")
            ...
            || String(audit?.cleanupScope?.scopeId || "") !== String(audit?.scopeId || ""))
            issues.push("post_compact_cleanup_scope_binding_invalid");
        if (audit?.cleanupScope?.allowsGlobalReset !== false)
            issues.push("post_compact_cleanup_global_reset_not_forbidden");
        if (audit?.cleanupScope?.allowsOtherGroupSessionReset !== false)
            issues.push("post_compact_cleanup_cross_session_reset_not_forbidden");
        if (audit?.partialSidecarOnly === true && audit?.resetDerivedCompactState !== false)
            issues.push("post_compact_cleanup_partial_sidecar_reset_invalid");
        if (audit?.partialSidecarOnly !== true && audit?.resetDerivedCompactState !== true)
            issues.push("post_compact_cleanup_primary_reset_missing");
        if (String(audit?.audit_checksum || "") !== groupPostCompactCleanupAuditChecksum(audit))
            issues.push("post_compact_cleanup_audit_checksum_invalid");
    }
    if (expected.groupId && String(audit?.groupId || "") !== String(expected.groupId))
        issues.push("post_compact_cleanup_group_mismatch");
    if (expected.groupSessionId && String(audit?.groupSessionId || "") !== String(expected.groupSessionId))
        issues.push("post_compact_cleanup_group_session_mismatch");
    if (expected.boundaryId && String(audit?.boundaryId || "") !== String(expected.boundaryId))
        issues.push("post_compact_cleanup_boundary_mismatch");
    if (expected.auditChecksum && String(audit?.audit_checksum || "") !== String(expected.auditChecksum))
        issues.push("post_compact_cleanup_checksum_mismatch");
...
function groupCompactLineageChecksum(lineage) {
    const payload = { ...(lineage || {}) };
    delete payload.lineage_checksum;
    delete payload.checksum_valid;
    return crypto.createHash("sha256").update(JSON.stringify(payload)).digest("hex");
}
function groupCompactTurnId(groupId, groupSessionId, boundaryId) {
...
function buildGroupCompactLineage(input = {}) {
    ...
    const previousCompactTurnId = previousBoundaryId
        ? String(input.previousCompactTurnId
    ...
    const payload = {
        ...
        version: exports.GROUP_COMPACT_LINEAGE_VERSION,
        group_id: groupId,
...
function verifyGroupCompactLineage(lineage, expected = {}) {
    const issues = [];
    if (lineage?.schema !== "ccm-group-compact-lineage-v1"
        || Number(lineage?.version || 0) !== exports.GROUP_COMPACT_LINEAGE_VERSION)
        issues.push("compact_lineage_schema_invalid");
    if (!String(lineage?.group_id || ""))
        issues.push("compact_lineage_group_missing");
    if (!String(lineage?.group_session_id || "").startsWith("gcs_"))
        issues.push("compact_lineage_exact_session_missing");
    if (!String(lineage?.boundary_id || ""))
        issues.push("compact_lineage_boundary_missing");
    if (String(lineage?.compact_epoch || "") !== buildGroupCompactEpoch(String(lineage?.boundary_id || "")))
        issues.push("compact_lineage_epoch_invalid");
    if (String(lineage?.compact_turn_id || "") !== groupCompactTurnId(String(lineage?.group_id || ""), String(lineage?.group_session_id || ""), String(lineage?.boundary_id || "")))
        issues.push("compact_lineage_turn_id_invalid");
    if (!["manual", "auto"].includes(String(lineage?.trigger || "")))
        issues.push("compact_lineage_trigger_invalid");
    if (String(lineage?.lineage_checksum || "") !== groupCompactLineageChecksum(lineage))
        issues.push("compact_lineage_checksum_invalid");
    const previousBoundaryId = String(lineage?.previous_boundary_id || "");
    if (previousBoundaryId) {
        if (String(lineage?.previous_compact_epoch || "") !== buildGroupCompactEpoch(previousBoundaryId))
            issues.push("compact_lineage_previous_epoch_invalid");
        if (!String(lineage?.previous_compact_turn_id || ""))
            issues.push("compact_lineage_previous_turn_missing");
        if (lineage?.checkpoint_basis === "message_count_checkpoint" && Number(lineage?.turns_since_previous_compact ?? -1) < 0)
            issues.push("compact_lineage_turn_count_invalid");
        if (lineage?.is_recompaction_in_chain === true && Number(lineage?.turns_since_previous_compact ?? -1) !== 0)
            issues.push("compact_lineage_recompaction_invalid");
    }
    ...
    if (expected.groupId && String(lineage?.group_id || "") !== String(expected.groupId))
        issues.push("compact_lineage_group_mismatch");
    if (expected.groupSessionId && String(lineage?.group_session_id || "") !== String(expected.groupSessionId))
        issues.push("compact_lineage_session_mismatch");
    if (expected.boundaryId && String(lineage?.boundary_id || "") !== String(expected.boundaryId))
        issues.push("compact_lineage_boundary_mismatch");
    if (expected.previousBoundaryId !== undefined && previousBoundaryId !== String(expected.previousBoundaryId || ""))
        issues.push("compact_lineage_previous_boundary_mismatch");
    return { valid: issues.length === 0, issues };
}
function groupCompactionModelUsageChecksum(receipt) {
    const payload = { ...(receipt || {}) };
    delete payload.usage_checksum;
    delete payload.checksum_valid;
    return crypto.createHash("sha256").update(JSON.stringify(payload)).digest("hex");
}
function finiteUsageToken(value) {
    const number = Number(value);
    return Number.isFinite(number) && number > 0 ? Math.floor(number) : 0;
}
function buildGroupCompactionModelUsageReceipt(input = {}) {
    ...
    const inputTokens = Math.max(finiteUsageToken(raw.input_tokens), finiteUsageToken(raw.inputTokens), finiteUsageToken(raw.prompt_tokens), finiteUsageToken(raw.promptTokens));
    const outputTokens = Math.max(finiteUsageToken(raw.output_tokens), finiteUsageToken(raw.outputTokens), finiteUsageToken(raw.completion_tokens), finiteUsageToken(raw.completionTokens));
    const cacheReadTokens = Math.max(finiteUsageToken(raw.cache_read_input_tokens), finiteUsageToken(raw.cacheReadInputTokens), finiteUsageToken(raw.prompt_tokens_details?.cached_tokens), finiteUsageToken(raw.promptTokensDetails?.cachedTokens));
    const cacheCreationTokens = Math.max(finiteUsageToken(raw.cache_creation_input_tokens), finiteUsageToken(raw.cacheCreationInputTokens));
    ...
    const payload = {
        ...
        version: exports.GROUP_COMPACTION_MODEL_USAGE_VERSION,
...
function verifyGroupCompactionModelUsageReceipt(receipt, expected = {}) {
    const issues = [];
    if (receipt?.schema !== "ccm-group-compaction-model-usage-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_COMPACTION_MODEL_USAGE_VERSION)
        issues.push("compaction_model_usage_schema_invalid");
    if (!String(receipt?.group_id || ""))
        issues.push("compaction_model_usage_group_missing");
    if (!String(receipt?.group_session_id || "").startsWith("gcs_"))
        issues.push("compaction_model_usage_exact_session_missing");
    if (!["reported", "unreported", "failed"].includes(String(receipt?.status || "")))
        issues.push("compaction_model_usage_status_invalid");
    if (receipt?.body_free !== true)
        issues.push("compaction_model_usage_body_free_missing");
    if (Number(receipt?.accounted_total_tokens || 0) < Number(receipt?.input_tokens || 0) + Number(receipt?.output_tokens || 0))
        issues.push("compaction_model_usage_total_invalid");
    if (String(receipt?.usage_checksum || "") !== groupCompactionModelUsageChecksum(receipt))
        issues.push("compaction_model_usage_checksum_invalid");
    if (expected.groupId && String(receipt?.group_id || "") !== String(expected.groupId))
        issues.push("compaction_model_usage_group_mismatch");
    if (expected.groupSessionId && String(receipt?.group_session_id || "") !== String(expected.groupSessionId))
        issues.push("compaction_model_usage_session_mismatch");
    if (expected.provider && String(receipt?.provider || "") !== String(expected.provider))
        issues.push("compaction_model_usage_provider_mismatch");
    if (expected.model && String(receipt?.model || "") !== String(expected.model))
        issues.push("compaction_model_usage_model_mismatch");
    return { valid: issues.length === 0, issues };
}
function groupPostCompactMessageOrderReceiptChecksum(receipt) {
    const payload = { ...(receipt || {}) };
    delete payload.receipt_checksum;
    delete payload.checksum_valid;
    return crypto.createHash("sha256").update(JSON.stringify(payload)).digest("hex");
}
function buildGroupPostCompactMessageOrderReceipt(input = {}) {
    const boundary = input.boundary || {};
    ...
    const postHookRows = (Array.isArray(input.postHookResults) ? input.postHookResults : []).map((row) => ({
    ...
    const payload = {
        ...
        version: exports.GROUP_POST_COMPACT_MESSAGE_ORDER_VERSION,
...
function verifyGroupPostCompactMessageOrderReceipt(receipt, expected = {}) {
    const issues = [];
    ...
    if (receipt?.schema !== "ccm-group-post-compact-message-order-receipt-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_POST_COMPACT_MESSAGE_ORDER_VERSION)
        issues.push("post_compact_message_order_schema_invalid");
    if (!String(receipt?.group_id || ""))
        issues.push("post_compact_message_order_group_missing");
    if (!String(receipt?.group_session_id || "").startsWith("gcs_"))
        issues.push("post_compact_message_order_exact_session_missing");
    if (!String(receipt?.boundary_id || ""))
        issues.push("post_compact_message_order_boundary_missing");
    if (JSON.stringify(receipt?.order || []) !== JSON.stringify(expectedOrder))
        issues.push("post_compact_message_order_invalid");
    if (!String(receipt?.summary_checksum || ""))
        issues.push("post_compact_message_order_summary_missing");
    if (String(receipt?.compact_epoch || "") !== buildGroupCompactEpoch(String(receipt?.boundary_id || "")))
        issues.push("post_compact_message_order_epoch_invalid");
    if (String(receipt?.receipt_checksum || "") !== groupPostCompactMessageOrderReceiptChecksum(receipt))
        issues.push("post_compact_message_order_checksum_invalid");
    if (expected.groupId && String(receipt?.group_id || "") !== String(expected.groupId))
        issues.push("post_compact_message_order_group_mismatch");
    if (expected.groupSessionId && String(receipt?.group_session_id || "") !== String(expected.groupSessionId))
        issues.push("post_compact_message_order_session_mismatch");
    if (expected.boundaryId && String(receipt?.boundary_id || "") !== String(expected.boundaryId))
        issues.push("post_compact_message_order_boundary_mismatch");
    if (expected.summaryChecksum && String(receipt?.summary_checksum || "") !== String(expected.summaryChecksum))
        issues.push("post_compact_message_order_summary_mismatch");
    return { valid: issues.length === 0, issues };
}
function groupPostCompactSessionStateResetChecksum(receipt) {
    const payload = { ...(receipt || {}) };
    delete payload.receipt_checksum;
    delete payload.checksum_valid;
    return crypto.createHash("sha256").update(JSON.stringify(payload)).digest("hex");
...
function buildGroupPostCompactSessionStateResetReceipt(input = {}) {
    const boundary = input.boundary || {};
    ...
    const previousGeneration = Math.max(0, Number(previousReceipt?.cache_read_baseline?.generation
        || previousReceipt?.post_compact_mark?.generation
        || 0));
    const generation = previousGeneration + 1;
    const durableCursor = String(input.durableBoundaryCursor
    ...
    const payload = {
        ...
        version: exports.GROUP_POST_COMPACT_SESSION_STATE_RESET_VERSION,
        group_id: String(input.groupId || input.group_id || ""),
        group_session_id: String(input.groupSessionId || input.group_session_id || ""),
...
function verifyGroupPostCompactSessionStateResetReceipt(receipt, expected = {}) {
    const issues = [];
    if (receipt?.schema !== "ccm-group-post-compact-session-state-reset-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_POST_COMPACT_SESSION_STATE_RESET_VERSION)
        issues.push("post_compact_session_state_reset_schema_invalid");
    if (!String(receipt?.group_id || ""))
        issues.push("post_compact_session_state_reset_group_missing");
    if (!String(receipt?.group_session_id || "").startsWith("gcs_"))
        issues.push("post_compact_session_state_reset_exact_session_missing");
    if (String(receipt?.scope_id || "") !== `${String(receipt?.group_id || "")}--${String(receipt?.group_session_id || "")}`)
        issues.push("post_compact_session_state_reset_scope_invalid");
    if (!String(receipt?.boundary_id || ""))
        issues.push("post_compact_session_state_reset_boundary_missing");
    if (String(receipt?.compact_epoch || "") !== buildGroupCompactEpoch(String(receipt?.boundary_id || "")))
        issues.push("post_compact_session_state_reset_epoch_invalid");
    if (!String(receipt?.summary_checksum || ""))
        issues.push("post_compact_session_state_reset_summary_missing");
    if (!String(receipt?.compact_transaction_receipt_checksum || ""))
        issues.push("post_compact_session_state_reset_transaction_missing");
    if (!["session_memory_reuse", "traditional"].includes(String(receipt?.compact_path || "")))
        issues.push("post_compact_session_state_reset_path_invalid");
    if (receipt?.durable_boundary_cursor?.status !== "preserved" || !String(receipt?.durable_boundary_cursor?.message_id || ""))
        issues.push("post_compact_session_state_reset_durable_cursor_invalid");
    if (receipt?.provider_active_cursor?.status !== "cleared" || String(receipt?.provider_active_cursor?.message_id || ""))
        issues.push("post_compact_session_state_reset_provider_cursor_not_cleared");
    if (receipt?.session_memory_extraction_cursor?.status !== "rebased_on_post_compact_snapshot"
        || String(receipt?.session_memory_extraction_cursor?.message_id || "") !== String(receipt?.durable_boundary_cursor?.message_id || ""))
        issues.push("post_compact_session_state_reset_extraction_cursor_invalid");
    const generation = Math.max(0, Number(receipt?.cache_read_baseline?.generation || 0));
    if (receipt?.cache_read_baseline?.status !== "reset"
        || generation !== Math.max(0, Number(receipt?.cache_read_baseline?.previous_generation || 0)) + 1)
        issues.push("post_compact_session_state_reset_cache_baseline_invalid");
    if (Number(receipt?.session_memory_extraction_cursor?.generation || 0) !== generation
        || receipt?.post_compact_mark?.status !== "marked"
        || Number(receipt?.post_compact_mark?.generation || 0) !== generation)
        issues.push("post_compact_session_state_reset_generation_invalid");
    if (receipt?.compact_warning?.suppressed !== true || receipt?.compact_warning?.status !== "suppressed")
        issues.push("post_compact_session_state_reset_warning_not_suppressed");
    if (receipt?.auto_compact_failure_state?.status !== "reset"
        || Number(receipt?.auto_compact_failure_state?.consecutive_failures || 0) !== 0)
        issues.push("post_compact_session_state_reset_failure_count_not_reset");
    if (receipt?.provider_capacity_reset?.reset !== true)
        issues.push("post_compact_session_state_reset_provider_capacity_not_reset");
    if (receipt?.body_free !== true)
        issues.push("post_compact_session_state_reset_body_free_missing");
    if (String(receipt?.receipt_checksum || "") !== groupPostCompactSessionStateResetChecksum(receipt))
        issues.push("post_compact_session_state_reset_checksum_invalid");
    if (expected.groupId && String(receipt?.group_id || "") !== String(expected.groupId))
        issues.push("post_compact_session_state_reset_group_mismatch");
    if (expected.groupSessionId && String(receipt?.group_session_id || "") !== String(expected.groupSessionId))
        issues.push("post_compact_session_state_reset_session_mismatch");
    if (expected.boundaryId && String(receipt?.boundary_id || "") !== String(expected.boundaryId))
        issues.push("post_compact_session_state_reset_boundary_mismatch");
    if (expected.summaryChecksum && String(receipt?.summary_checksum || "") !== String(expected.summaryChecksum))
        issues.push("post_compact_session_state_reset_summary_mismatch");
    return { valid: issues.length === 0, issues };
}
function verifyGroupCompactTransactionReceipt(receipt, expected = {}) {
    ...
    const supportedSchema = (receipt?.schema === "ccm-group-memory-compact-transaction-receipt-v1" && receiptVersion === 1)
        ...
        || (receipt?.schema === "ccm-group-memory-compact-transaction-receipt-v3" && receiptVersion === exports.GROUP_COMPACT_TRANSACTION_RECEIPT_VERSION);
    if (!supportedSchema)
    ...
    if (!String(receipt?.group_session_id || "").startsWith("gcs_"))
        issues.push("compact_transaction_exact_group_session_missing");
    if (!String(receipt?.boundary_id || ""))
    ...
    if (receiptVersion >= 3 && !String(receipt?.cleanup_audit_checksum || ""))
        issues.push("compact_transaction_cleanup_audit_checksum_missing");
    ...
    if (expected.cleanupAuditChecksum && String(receipt?.cleanup_audit_checksum || "") !== String(expected.cleanupAuditChecksum))
        issues.push("compact_transaction_cleanup_audit_mismatch");
    return { valid: issues.length === 0, issues };
}
...
function getGroupMemoryCompactionHookLedgerFile(groupId, groupSessionId) {
    ...
    return path.join(GROUP_COMPACTION_HOOK_LEDGER_DIR, cleanHookLedgerGroupId(id), `${cleanHookLedgerGroupId(sessionId)}.json`);
}
    ...
    try {
        if (fs.existsSync(file)) {
            ...
            if (parsed.schema !== "ccm-group-memory-compaction-hook-ledger-v2"
                || Number(parsed.version || 0) !== exports.GROUP_COMPACTION_HOOK_LEDGER_VERSION)
...
function verifyGroupCompactionSummaryInputProjectionReceipt(receipt, expected = {}) {
    const issues = [];
    if (receipt?.schema !== "ccm-group-compaction-summary-input-projection-v1" || Number(receipt?.version || 0) !== exports.GROUP_COMPACTION_SUMMARY_INPUT_PROJECTION_VERSION)
...
function sanitizeCompactionSummaryString(value, state, key = "") {
    ...
    output = output.replace(/data:image\/[a-z0-9.+-]+;base64,[a-z0-9+/=]{64,}/gi, () => {
        ...
        return exports.GROUP_COMPACTION_SUMMARY_IMAGE_MARKER;
    });
    output = output.replace(/data:(?:application\/pdf|application\/[a-z0-9.+-]+);base64,[a-z0-9+/=]{64,}/gi, () => {
        state.binarySegmentsStripped += 1;
        return exports.GROUP_COMPACTION_SUMMARY_DOCUMENT_MARKER;
    });
    output = output.replace(/[a-z0-9+/]{256,}={0,2}/gi, () => {
        state.binarySegmentsStripped += 1;
        return exports.GROUP_COMPACTION_SUMMARY_BINARY_MARKER;
    });
...
function sanitizeCompactionSummaryValue(value, state, key = "") {
    ...
    if (GROUP_COMPACTION_IMAGE_BLOCK_TYPES.has(type)) {
        ...
        return { type: "text", text: exports.GROUP_COMPACTION_SUMMARY_IMAGE_MARKER };
    }
    if (GROUP_COMPACTION_DOCUMENT_BLOCK_TYPES.has(type)) {
        state.documentBlocksStripped += 1;
        return { type: "text", text: exports.GROUP_COMPACTION_SUMMARY_DOCUMENT_MARKER };
    }
    const next = {};
...
function buildGroupCompactionSummaryInputProjection(messages = [], options = {}) {
    ...
    const payload = {
        ...
        version: exports.GROUP_COMPACTION_SUMMARY_INPUT_PROJECTION_VERSION,
        ...
        image_marker: exports.GROUP_COMPACTION_SUMMARY_IMAGE_MARKER,
        document_marker: exports.GROUP_COMPACTION_SUMMARY_DOCUMENT_MARKER,
        binary_marker: exports.GROUP_COMPACTION_SUMMARY_BINARY_MARKER,
    };
...
function verifyGroupSessionMemoryApiInvariantClosure(receipt) {
    ...
    if (receipt?.schema !== "ccm-group-session-memory-api-invariant-closure-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_SESSION_MEMORY_API_INVARIANT_CLOSURE_VERSION)
...
function adjustGroupSessionMemoryKeepIndexToPreserveApiInvariants(messages, startIndex, options = {}) {
    ...
    const core = {
        ...
        version: exports.GROUP_SESSION_MEMORY_API_INVARIANT_CLOSURE_VERSION,
...
function buildGroupSessionMemoryCompactProjection(input = {}) {
    ...
    const maxSectionTokens = Math.max(250, Math.floor(Number(input.maxSectionTokens || input.max_section_tokens || exports.GROUP_SESSION_MEMORY_COMPACT_DEFAULT_MAX_SECTION_TOKENS)));
    const maxTotalTokens = Math.max(maxSectionTokens, Math.floor(Number(input.maxTotalTokens || input.max_total_tokens || exports.GROUP_SESSION_MEMORY_COMPACT_DEFAULT_MAX_TOTAL_TOKENS)));
    ...
    const payload = {
        ...
        version: exports.GROUP_SESSION_MEMORY_COMPACT_PROJECTION_VERSION,
        group_id: groupId,
        group_session_id: groupSessionId,
        scope_id: scopeId,
...
function verifyGroupSessionMemoryCompactProjection(receipt, expected = {}) {
    ...
    if (receipt?.schema !== "ccm-group-session-memory-compact-projection-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_SESSION_MEMORY_COMPACT_PROJECTION_VERSION)
...
function buildGroupSessionMemoryCompactSelectionReceipt(input = {}) {
    ...
    const payload = {
        ...
        version: exports.GROUP_SESSION_MEMORY_COMPACT_SELECTION_VERSION,
        group_id: String(input.groupId || input.group_id || ""),
        group_session_id: String(input.groupSessionId || input.group_session_id || ""),
...
function verifyGroupSessionMemoryCompactSelectionReceipt(receipt, expected = {}) {
    ...
    if (receipt?.schema !== "ccm-group-session-memory-compact-selection-v1"
        || ![1, exports.GROUP_SESSION_MEMORY_COMPACT_SELECTION_VERSION].includes(version))
...
async function selectGroupSessionMemoryForCompact(input = {}) {
    ...
    const compactProjection = buildGroupSessionMemoryCompactProjection({
        ...
        maxTotalTokens: config.sessionMemoryCompactMaxTotalTokens
            ...
            || exports.GROUP_SESSION_MEMORY_COMPACT_DEFAULT_MAX_TOTAL_TOKENS,
        createdAt: input.now,
    });
...
function verifyGroupTimeBasedToolResultProjectionReceipt(receipt, expected = {}) {
    const issues = [];
    if (receipt?.schema !== "ccm-group-time-based-tool-result-projection-v1" || Number(receipt?.version || 0) !== exports.GROUP_TIME_BASED_TOOL_RESULT_PROJECTION_VERSION)
...
function clearProjectedToolResultValue(value, clearIds, state) {
    ...
    if ((type === "tool_result" || type === "web_search_tool_result") && clearIds.has(id)) {
        ...
        if (current === exports.GROUP_TIME_BASED_TOOL_RESULT_CLEARED_MESSAGE)
            return value;
        state.tokensSaved += Math.max(0, estimateGroupTextTokens(renderMessageContentValue(current)) - estimateGroupTextTokens(exports.GROUP_TIME_BASED_TOOL_RESULT_CLEARED_MESSAGE));
        state.cleared += 1;
        return { ...value, content: exports.GROUP_TIME_BASED_TOOL_RESULT_CLEARED_MESSAGE, output: undefined, result: undefined, text: undefined };
    }
    const next = { ...value };
...
function buildGroupTimeBasedToolResultProjection(messages = [], options = {}) {
    ...
    for (const [id, name] of toolNamesById)
        if (GROUP_TIME_BASED_COMPACTABLE_TOOL_NAMES.has(normalizedToolName(name)))
    ...
    const projectedMessages = clearIds.size ? (messages || []).map(message => {
        ...
        if (Array.isArray(message?.tool_results || message?.toolResults)) {
            ...
            next[key] = (message.tool_results || message.toolResults).map((result) => {
                ...
                state.tokensSaved += Math.max(0, estimateGroupTextTokens(renderMessageContentValue(current)) - estimateGroupTextTokens(exports.GROUP_TIME_BASED_TOOL_RESULT_CLEARED_MESSAGE));
                state.cleared += 1;
                return { ...result, content: exports.GROUP_TIME_BASED_TOOL_RESULT_CLEARED_MESSAGE, output: undefined, result: undefined, text: undefined };
            });
        }
        return next;
    }) : messages;
    ...
    const payload = {
        ...
        version: exports.GROUP_TIME_BASED_TOOL_RESULT_PROJECTION_VERSION,
        group_id: groupId,
        group_session_id: groupSessionId,
        ...
        raw_transcript_preserved: true,
        cleared_content_marker: exports.GROUP_TIME_BASED_TOOL_RESULT_CLEARED_MESSAGE,
...
function verifyGroupTimeBasedThinkingProjectionReceipt(receipt, expected = {}) {
    const issues = [];
    if (receipt?.schema !== "ccm-group-time-based-thinking-projection-v1" || Number(receipt?.version || 0) !== exports.GROUP_TIME_BASED_THINKING_PROJECTION_VERSION)
...
function clearProjectedThinkingValue(value, state) {
    ...
    if (String(value.type || "") === "thinking") {
        ...
        state.tokensSaved += Math.max(0, estimateGroupTextTokens(renderMessageContentValue(current)) - estimateGroupTextTokens(exports.GROUP_TIME_BASED_THINKING_CLEARED_MESSAGE));
        state.clearedBlocks += 1;
        return { type: "text", text: exports.GROUP_TIME_BASED_THINKING_CLEARED_MESSAGE };
    }
    const next = { ...value };
    if (Array.isArray(value.content) || value.content && typeof value.content === "object")
...
function buildGroupTimeBasedThinkingProjection(messages = [], options = {}) {
    ...
    const projectedMessages = clearThinkingMessageIds.size ? (messages || []).map((message, index) => {
        ...
        if (String(message?.role || "").toLowerCase() === "thinking") {
            ...
            state.tokensSaved += Math.max(0, estimateGroupTextTokens(renderMessageContentValue(current)) - estimateGroupTextTokens(exports.GROUP_TIME_BASED_THINKING_CLEARED_MESSAGE));
            state.clearedBlocks += 1;
            next.content = exports.GROUP_TIME_BASED_THINKING_CLEARED_MESSAGE;
            if ("thinking" in next)
    ...
    const payload = {
        ...
        version: exports.GROUP_TIME_BASED_THINKING_PROJECTION_VERSION,
        group_id: groupId,
        group_session_id: groupSessionId,
        scope_id: `${groupId}::${groupSessionId}`,
        query_source: querySource,
        ...
        evaluated_at: new Date(nowMs).toISOString(),
        raw_transcript_preserved: true,
        cleared_content_marker: exports.GROUP_TIME_BASED_THINKING_CLEARED_MESSAGE,
    };
...
function verifyGroupApiMicrocompactNativeApplyPlan(plan = {}, expected = {}) {
    ...
    if (plan?.schema !== "ccm-api-microcompact-native-apply-plan-v1"
        || Number(plan?.version || 0) !== exports.GROUP_API_MICROCOMPACT_NATIVE_APPLY_PLAN_VERSION)
        issues.push("schema");
    ...
    if (plan.nativeApplyReady === true) {
        ...
        if (!Array.isArray(requestPatch?.beta_headers) || !requestPatch.beta_headers.includes(exports.GROUP_API_MICROCOMPACT_CONTEXT_MANAGEMENT_BETA))
...
function verifyGroupPostCompactTaskStatusProjectionReceipt(receipt, expected = {}) {
    ...
    if (receipt?.schema !== "ccm-group-post-compact-task-status-projection-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_POST_COMPACT_TASK_STATUS_PROJECTION_VERSION)
...
function buildGroupPostCompactTaskStatusProjection(tasks = [], options = {}) {
    ...
    const budget = Math.max(1, Math.min(40, Number(options.taskStatusBudget || options.task_status_budget || exports.GROUP_POST_COMPACT_TASK_STATUS_BUDGET)));
    ...
    const payload = {
        ...
        version: exports.GROUP_POST_COMPACT_TASK_STATUS_PROJECTION_VERSION,
        group_id: groupId,
        group_session_id: groupSessionId,
...
function collectPreservedReadPaths(messages = []) {
    ...
    for (const message of Array.isArray(messages) ? messages : []) {
        for (const block of postCompactMessageBlocks(message)) {
            ...
            if (!resultText.startsWith(exports.GROUP_FILE_UNCHANGED_STUB_PREFIX))
                continue;
...
function verifyGroupPostCompactFileRestoreDedupReceipt(receipt, expected = {}) {
    ...
    if (receipt?.schema !== "ccm-group-post-compact-file-restore-dedup-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_POST_COMPACT_FILE_RESTORE_DEDUP_VERSION)
...
function buildGroupPostCompactFileRestoreDedupProjection(fileCandidates = [], preservedMessages = [], options = {}) {
    ...
    const payload = {
        ...
        version: exports.GROUP_POST_COMPACT_FILE_RESTORE_DEDUP_VERSION,
        group_id: groupId,
        group_session_id: groupSessionId,
        projection_only: true,
        raw_transcript_preserved: true,
...
function verifyGroupPostCompactInvokedSkillAttachmentReceipt(receipt, expected = {}) {
    ...
    if (receipt?.schema !== "ccm-group-post-compact-invoked-skill-attachment-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_POST_COMPACT_INVOKED_SKILL_ATTACHMENT_VERSION)
    ...
    if (Number(receipt?.single_skill_max_tokens || 0) !== exports.GROUP_POST_COMPACT_INVOKED_SKILL_MAX_TOKENS)
        issues.push("post_compact_invoked_skill_attachment_single_budget_invalid");
    if (Number(receipt?.total_max_tokens || 0) !== exports.GROUP_POST_COMPACT_INVOKED_SKILLS_TOTAL_MAX_TOKENS)
...
function buildGroupPostCompactInvokedSkillAttachmentProjection(messages = [], options = {}) {
    ...
    const singleSkillMaxTokens = Math.max(1, Math.min(exports.GROUP_POST_COMPACT_INVOKED_SKILL_MAX_TOKENS, Number(options.singleSkillMaxTokens || options.single_skill_max_tokens || exports.GROUP_POST_COMPACT_INVOKED_SKILL_MAX_TOKENS)));
    const totalMaxTokens = Math.max(1, Math.min(exports.GROUP_POST_COMPACT_INVOKED_SKILLS_TOTAL_MAX_TOKENS, Number(options.totalMaxTokens || options.total_max_tokens || exports.GROUP_POST_COMPACT_INVOKED_SKILLS_TOTAL_MAX_TOKENS)));
    ...
    const payload = {
        ...
        version: exports.GROUP_POST_COMPACT_INVOKED_SKILL_ATTACHMENT_VERSION,
        group_id: groupId,
        group_session_id: groupSessionId,
        scope_id: `${groupId}::${groupSessionId}`,
...
function compactPostCompactPlanBody(body) {
    ...
    if (originalTokens <= exports.GROUP_POST_COMPACT_PLAN_MAX_TOKENS) {
    ...
    while (low <= high) {
        ...
        if (estimateGroupTextTokens(candidate) <= exports.GROUP_POST_COMPACT_PLAN_MAX_TOKENS) {
            selected = candidate;
            low = middle + 1;
        }
        else {
...
function verifyGroupPostCompactPlanAttachmentReceipt(receipt, expected = {}) {
    ...
    if (receipt?.schema !== "ccm-group-post-compact-plan-attachment-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_POST_COMPACT_PLAN_ATTACHMENT_VERSION)
    ...
    if (Number(receipt?.max_plan_tokens || 0) !== exports.GROUP_POST_COMPACT_PLAN_MAX_TOKENS)
        issues.push("post_compact_plan_attachment_budget_invalid");
    if (Number(receipt?.attachment_token_count || 0) > exports.GROUP_POST_COMPACT_PLAN_MAX_TOKENS)
...
function buildGroupPostCompactPlanAttachmentProjection(tasks = [], options = {}) {
    ...
    const payload = {
        ...
        version: exports.GROUP_POST_COMPACT_PLAN_ATTACHMENT_VERSION,
        group_id: groupId,
        group_session_id: groupSessionId,
        scope_id: `${groupId}::${groupSessionId}`,
        exact_session_only: true,
        ...
        max_plan_tokens: exports.GROUP_POST_COMPACT_PLAN_MAX_TOKENS,
...
function buildPreCompactLoadedToolState(catalogTools, messages, carriedValues = []) {
    ...
    return {
        ...
        version: exports.GROUP_POST_COMPACT_LOADED_TOOL_STATE_VERSION,
...
function verifyGroupPostCompactDynamicContextDeltaReceipt(receipt, expected = {}) {
    ...
    if (receipt?.schema !== "ccm-group-post-compact-dynamic-context-delta-v1"
        || Number(receipt?.version || 0) !== exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_DELTA_VERSION)
    ...
    if (Number(receipt?.max_attachment_tokens || 0) !== exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_MAX_TOKENS)
        issues.push("post_compact_dynamic_context_delta_budget_invalid");
    if (Number(receipt?.attachment_token_count || 0) > exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_MAX_TOKENS)
    ...
    if (loadedToolState !== undefined && loadedToolState !== null) {
        if (loadedToolState?.schema !== "ccm-group-post-compact-loaded-tool-state-v1"
            || Number(loadedToolState?.version || 0) !== exports.GROUP_POST_COMPACT_LOADED_TOOL_STATE_VERSION)
...
function buildGroupPostCompactDynamicContextDeltaProjection(catalog = {}, options = {}) {
    ...
    const payload = {
        ...
        version: exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_DELTA_VERSION,
        group_id: groupId,
        group_session_id: groupSessionId,
        scope_id: `${groupId}::${groupSessionId}`,
        exact_session_only: true,
        ...
        attachment_count: attachment ? 1 : 0,
        max_attachment_tokens: exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_MAX_TOKENS,
        attachment_token_count: Number(attachment?.tokenCount || 0),
        original_token_count: Number(attachment?.originalTokenCount || 0),
        truncated: attachment?.truncated === true,
        deferred_tools: {
...
function buildPostCompactReinjectionPlan(messages, microCompact = {}, options = {}) {
    ...
    const taskStatusBudget = Math.max(1, Number(options.taskStatusBudget || options.task_status_budget || exports.GROUP_POST_COMPACT_TASK_STATUS_BUDGET));
    const fileRows = [];
    const skillRows = [];
    ...
    return {
        ...
        budgets: {
            ...
            invokedSkillSingleTokens: exports.GROUP_POST_COMPACT_INVOKED_SKILL_MAX_TOKENS,
            invokedSkillsTotalTokens: exports.GROUP_POST_COMPACT_INVOKED_SKILLS_TOTAL_MAX_TOKENS,
            currentPlanTokens: exports.GROUP_POST_COMPACT_PLAN_MAX_TOKENS,
            dynamicContextTokens: exports.GROUP_POST_COMPACT_DYNAMIC_CONTEXT_MAX_TOKENS,
        },
        files,
        skills,
        verification,
...
function buildGroupTruePostCompactPayloadBudget(input = {}) {
    const triggerTokens = Math.max(1, Number(input.triggerTokens || input.autoCompactThreshold || exports.GROUP_COMPACT_TRIGGER_TOKENS));
    ...
    const core = {
        ...
        version: exports.GROUP_TRUE_POST_COMPACT_PAYLOAD_VERSION,
        group_id: String(input.groupId || input.group_id || ""),
        group_session_id: String(input.groupSessionId || input.group_session_id || ""),
...
async function compactGroupConversationMemory(input) {
    ...
    const shouldAttemptModel = sessionMemoryCompactSelection?.selected !== true
        ...
        && (failures < exports.GROUP_COMPACT_MAX_FAILURES || retryWindowExpired);
