...
export declare function testAgentStatusLabel(status: any): "未知" | "未通过" | "待确认" | "未覆盖" | "通过" | "已跳过" | "部分通过" | "已阻塞" | "已覆盖" | "超时" | "已启动" | "已在运行";
...
export declare const COORDINATOR_REVIEW_MAX_ROUNDS: number;
