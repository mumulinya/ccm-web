...
exports.buildUxSelfTestTask = buildUxSelfTestTask;
exports.buildUxSelfTestReinjectionGateGapDelivery = buildUxSelfTestReinjectionGateGapDelivery;
exports.buildUxSelfTestReinjectionUsageGapDelivery = buildUxSelfTestReinjectionUsageGapDelivery;
exports.buildUxSelfTestChecks = buildUxSelfTestChecks;
const collaboration_1 = require("./collaboration");
function buildUxSelfTestTask(ctx = {}) {
    return ({
        id: "ux-task",
        title: "增加负责人筛选",
...
function buildUxSelfTestReinjectionGateGapDelivery(ctx = {}) {
    const { task } = ctx;
    return ({
...
function buildUxSelfTestReinjectionUsageGapDelivery(ctx = {}) {
    const { task } = ctx;
    return ({
        ...task.delivery_summary,
        acceptance_gate_passed: false,
...
function buildUxSelfTestChecks(ctx = {}) {
    ...
    return ({
        ...
        projectQuestionLoadsContextAfterToolUse: (0, collaboration_1.shouldLoadReadOnlyProjectContext)({ isOrchestrated: true, taskIntent: (0, collaboration_1.classifyGroupProjectTaskIntent)("你好，这是一个什么项目") }) === true,
        greetingWithoutToolDoesNotLoadProjects: (0, collaboration_1.shouldLoadReadOnlyProjectContext)({ isOrchestrated: true, taskIntent: (0, collaboration_1.classifyGroupProjectTaskIntent)("你好") }) === false,
...
//# sourceMappingURL=collaboration-ux-self-tests-fixtures.js.map