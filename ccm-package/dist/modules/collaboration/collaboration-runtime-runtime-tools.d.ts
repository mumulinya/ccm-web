...
export declare function prepareAgentRuntimeTools(groupId: string, projectName: string, workDir: string, agentType: string, allowedTools: any, streamRes?: any, options?: any): {
    audit: import("../../tools/runtime-tool-sync").RuntimeToolSyncAudit;
    workEvent: {
        id: string;
        time: string;
        agent: string;
        kind: string;
        text: string;
        runtimeToolSync: import("../../tools/runtime-tool-sync").RuntimeToolSyncAudit;
    };
    prompt: string;
    dispatchGate: import("../../tools/runtime-tool-sync").RuntimeToolDispatchGate;
