"use strict";
// memory-self-tests.ts — merged from 2 part files (behavior-freeze merge).
...
// ===== merged from memory-self-tests-part-01.ts =====
...
// ===== merged from memory-self-tests-part-02.ts =====
// Extracted self-tests. Runtime remains in memory.ts.
function runGroupGlobalAgentMemoryArbitrationContextSelfTest() {
    ...
    try {
        ...
        (0, memory_2.buildAgentMemoryContextBundle)(groupId, "api", "继续 GLOBAL_AGENT_ARBITRATION_SENTINEL src/arbitration.ts", {
            minKeepTokens: 1,
            maxGlobalAgentMemory: 4,
            allowSelftestGlobalMemoryForSelfTest: true,
        });
        const bundle = (0, memory_2.buildAgentMemoryContextBundle)(groupId, "api", "继续 GLOBAL_AGENT_ARBITRATION_SENTINEL src/arbitration.ts", {
            minKeepTokens: 1,
            maxGlobalAgentMemory: 4,
            allowSelftestGlobalMemoryForSelfTest: true,
        });
...
function runGroupGlobalAgentMemorySemanticArbitrationSelfTest() {
    ...
    try {
        ...
        const bundle = (0, memory_2.buildAgentMemoryContextBundle)(groupId, "api", "继续 GLOBAL_AGENT_SEMANTIC_ARBITRATION_SENTINEL src/semantic-arbitration.ts", {
            minKeepTokens: 1,
            maxGlobalAgentMemory: 4,
            allowSelftestGlobalMemoryForSelfTest: true,
        });
...
function runGroupGlobalAgentMemoryCrossGroupSuppressionContextSelfTest() {
    ...
    const cleanupFiles = [groupA, groupB].flatMap(groupId => [
        (0, memory_2.getGroupMessagesFileHint)(groupId),
        `${(0, memory_2.getGroupMessagesFileHint)(groupId)}.bak`,
        (0, memory_2.getGroupMemoryFile)(groupId),
        `${(0, memory_2.getGroupMemoryFile)(groupId)}.bak`,
        (0, memory_2.getGroupMemoryReloadLedgerFile)(groupId),
        `${(0, memory_2.getGroupMemoryReloadLedgerFile)(groupId)}.bak`,
        (0, memory_2.getGroupGlobalMemoryArbitrationLedgerFile)(groupId),
        `${(0, memory_2.getGroupGlobalMemoryArbitrationLedgerFile)(groupId)}.bak`,
    ]);
    ...
    try {
        ...
        const sourceBundle = (0, memory_2.buildAgentMemoryContextBundle)(groupA, "api", "继续 GLOBAL_AGENT_CROSS_GROUP_SUPPRESSION_SENTINEL src/cross-group.ts", {
            minKeepTokens: 1,
            maxGlobalAgentMemory: 4,
            allowSelftestGlobalMemoryForSelfTest: true,
        });
        ...
        const targetBundle = (0, memory_2.buildAgentMemoryContextBundle)(groupB, "api", "继续 GLOBAL_AGENT_CROSS_GROUP_SUPPRESSION_SENTINEL src/cross-group.ts", {
            minKeepTokens: 1,
            maxGlobalAgentMemory: 4,
        ...
        const checks = {
            sourceGroupRecordedConflict: sourceLedger.schema === "ccm-group-global-memory-arbitration-ledger-summary-v1"
                ...
                && fs.existsSync((0, memory_2.getGroupGlobalMemoryArbitrationLedgerFile)(groupA)),
            ...
            targetSuppressesByCrossGroupLedger: cross.suppressed === true
                ...
                && (cross.sourceLedgers || []).some((entry) => entry.file === (0, memory_2.getGroupGlobalMemoryArbitrationLedgerFile)(groupA)),
...
function runGroupGlobalAgentMemoryCrossGroupSuppressionFreshnessSelfTest() {
    ...
    try {
        ...
        const sourceBundle = (0, memory_2.buildAgentMemoryContextBundle)(groupA, "api", "继续 GLOBAL_AGENT_CROSS_GROUP_FRESHNESS_SENTINEL src/freshness.ts", {
            minKeepTokens: 1,
            maxGlobalAgentMemory: 4,
            allowSelftestGlobalMemoryForSelfTest: true,
        });
        ...
        const targetBundle = (0, memory_2.buildAgentMemoryContextBundle)(groupB, "api", "继续 GLOBAL_AGENT_CROSS_GROUP_FRESHNESS_SENTINEL src/freshness.ts", {
            minKeepTokens: 1,
            maxGlobalAgentMemory: 4,
            crossGroupGlobalMemoryConflictGroupThreshold: 1,
            allowSelftestGlobalMemoryForSelfTest: true,
...
function runGroupTypedMemoryContextSelfTest() {
    ...
    try {
        ...
        const bundle = (0, memory_2.buildAgentMemoryContextBundle)(groupId, "api", "继续支付回调 IDEMPOTENCY_CONTEXT_SENTINEL src/pay.ts npm run check", { minKeepTokens: 1 });
        const secondBundle = (0, memory_2.buildAgentMemoryContextBundle)(groupId, "api", "继续支付回调 IDEMPOTENCY_CONTEXT_SENTINEL src/pay.ts npm run check", { minKeepTokens: 1 });
        const ignored = (0, memory_2.buildAgentMemoryContextBundle)(groupId, "api", "本轮请忽略记忆，只处理当前任务");
...
function runGroupTypedMemoryContextPressureRepairProvenanceSelfTest() {
    ...
    const reloadFile = (0, memory_2.getGroupMemoryReloadLedgerFile)(groupId);
    const dispatchFile = (0, memory_2.getGroupPostCompactDispatchLedgerFile)(groupId);
    const repairFile = (0, memory_2.getGroupReplayRepairWorkItemsFile)(groupId);
    try {
        (0, storage_1.saveGroupMessages)(groupId, [{
                id: "phase131-1",
                role: "user",
        ...
        (0, memory_2.writeJsonAtomic)(repairFile, {
        ...
        const bundle = (0, memory_2.buildAgentMemoryContextBundle)(groupId, targetProject, "继续 WorkerContextPacket over_budget PRESSURE_CONTEXT_REPAIR_BUNDLE_SENTINEL", {
...
async function runGroupMemoryAutoCompactionSelfTest() {
    ...
    const messageFile = (0, memory_2.getGroupMessagesFileHint)(groupId, sessionId);
    const memoryFile = (0, memory_2.getGroupMemoryFile)(groupId, sessionId);
    ...
    try {
        ...
        const result = await (0, memory_2.runGroupMemoryAutoCompactionNow)(groupId, {
            sessionId,
            force: true,
            rebuild: true,
            reason: "selftest",
        ...
        const memory = (0, memory_2.loadGroupMemory)(groupId, sessionId);
...
//# sourceMappingURL=memory-self-tests.js.map