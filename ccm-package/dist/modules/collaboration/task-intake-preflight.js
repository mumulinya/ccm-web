...
function buildTaskPreflight(payload, req) {
    ...
    return {
        ...
        testAgent: { enabled: (0, test_agent_settings_1.isTestAgentEnabled)(), mode: (0, test_agent_settings_1.isTestAgentEnabled)() ? "independent_review" : "main_agent_self_verification" },
