"use strict";
// group-memory-loading.ts — merged from 3 part files (behavior-freeze merge).
...
// ===== merged from group-memory-loading-part-02.ts =====
// Extracted functional module. The original entry remains a compatibility facade.
...
function configureGroupTypedMemoryManifestSelector(executor) {
    ...
    return { configured: !!exports.configuredGroupTypedMemoryManifestSelectorExecutor };
}
...
async function selectGroupTypedMemoryManifest(scopeId, query, options = {}) {
    ...
    const executor = options.executor || exports.configuredGroupTypedMemoryManifestSelectorExecutor;
...
// ===== merged from group-memory-loading-part-03.ts =====
// Extracted functional module. The original entry remains a compatibility facade.
