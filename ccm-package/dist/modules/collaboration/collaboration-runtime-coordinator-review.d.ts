...
export declare function getGroupMainAgentActionRegistry(): ({
    backend: ("createTask" | "shouldCreatePersistentGroupTask" | "buildInlineTaskRuntime" | "buildGroupProjectAnalysisContext" | "getInitialWorkflowMeta" | "listExecutions" | "buildGroupContextPacket" | "buildRecentGroupContext" | "buildGroupMemoryContext" | "buildProjectCodeReadOnlySnapshot" | "queryKnowledgeBase" | "loadTasks" | "listTaskAgentSessions" | "buildTaskPreflightReasoning" | "recordReasoningRecoveryCheck" | "resumeTaskQueues" | "reopenTaskAgentSessions" | "runGroupOrchestrator" | "prepareAgentRuntimeTools" | "ctx.callAgent" | "queueTaskExecution" | "dispatchPolicy.action=ask_user" | "questionForUser" | "appendGroupMessage" | "requestTaskCancellation" | "archiveTask" | "restoreArchivedTask" | "purgeArchivedTask" | "releaseTaskLease" | "extractAgentReceipt" | "buildUserAgentQuestionRows" | "runLlmCoordinatorReview" | "recordReasoningDeviation" | "updateReasoningPlan" | "createReworkTask" | "buildUserDeliveryReport" | "buildTaskGroupReportMessage")[];
    evidence: ("task_id" | "CCM_AGENT_RECEIPT" | "risks" | "execution_id" | "group_memory" | "verification" | "task_status" | "acceptance_gate" | "work_dir" | "files_changed" | "project_memory" | "recovery_checks" | "work_items" | "task_card" | "recent_messages" | "active_goal" | "safe_file_snippets" | "rag_citations" | "matched_documents" | "execution_state" | "session_state" | "task_recovery" | "workflow_meta" | "dispatch_policy" | "assignments" | "missing_info" | "clarification_question" | "cancellation_record" | "archive_record" | "cleanup_result" | "receipt_statuses" | "failed_assertions" | "gap_fingerprint" | "rework_plan" | "verification_executed")[];
