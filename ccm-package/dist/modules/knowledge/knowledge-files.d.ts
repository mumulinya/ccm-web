...
export declare const RAG_INDEX_V3_DIR: string;
export declare const RAG_INDEX_V3_POINTER_FILE: string;
export declare const KNOWLEDGE_MODEL_DIR: string;
...
export declare function loadRagEmbeddingConfig(): KnowledgeEmbeddingConfigV3;
export declare function saveRagEmbeddingConfig(updates?: any): KnowledgeEmbeddingConfigV3;
export declare function publicRagEmbeddingConfig(config?: KnowledgeEmbeddingConfigV3): {
    apiUrl: string;
    hasKey: boolean;
    enabled: boolean;
    version: 3;
