    ...
    if (pathname === "/api/feishu/config" && req.method === "GET") {
        ...
        (0, utils_1.sendJson)(res, {
            config: {
                ...
                control_bot_app_id: config.control_bot_app_id || "",
                control_bot_app_secret: config.control_bot_app_secret ? "******" : "",
                ...
                control_bot_ready: !!(config.control_bot_enabled && config.control_bot_app_id && config.control_bot_app_secret && config.control_bot_verification_token && config.control_bot_public_base_url),
