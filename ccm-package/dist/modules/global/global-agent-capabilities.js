...
exports.GLOBAL_AGENT_CAPABILITY_REPLY = void 0;
exports.isGlobalAgentCapabilityQuestion = isGlobalAgentCapabilityQuestion;
const compact = (value) => String(value || "").replace(/\s+/g, "").trim();
/** Product-level reply for capability questions. It deliberately bypasses the model. */
exports.GLOBAL_AGENT_CAPABILITY_REPLY = [
...
function isGlobalAgentCapabilityQuestion(value) {
...
//# sourceMappingURL=global-agent-capabilities.js.map