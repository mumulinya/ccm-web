...
const { queueMusicPlayback, executePlayMusic, fillCronParams, executeFeishuManagementAction, executeFeishuAction } = globalAgentFeishuActions;
const globalAgentAgenticRuntime = (0, global_agent_agentic_runtime_1.createGlobalAgentAgenticRuntime)({
    ...
    compactGlobalAgentSession: memory_2.compactGlobalAgentSession,
    compactPetText,
...
function hasExplicitGlobalWriteAuthorization(message) { return globalAgentAgenticRuntime.hasExplicitGlobalWriteAuthorization(message); }
