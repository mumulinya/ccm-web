export declare const DEVELOPMENT_AGENT_CATALOG: readonly [{
    ...
    readonly id: "gemini";
    readonly aliases: readonly ["gemini", "geminicli", "gemini-cli", "antigravity", "antigravity-cli", "agy"];
    readonly label: "Antigravity CLI";
    readonly description: "使用 Google Antigravity 账号运行官方 Antigravity CLI（agy）。";
...
export declare function publicDevelopmentAgentCatalog(): ({
    aliases: ("claudecode" | "claude-code" | "claude_code" | "cc" | "claude" | "codex" | "cursor" | "agent" | "cursor-agent" | "gemini" | "geminicli" | "gemini-cli" | "antigravity" | "antigravity-cli" | "agy" | "opencode" | "open-code" | "qoder" | "qoder-cli")[];
