...
export declare function runMainAgentIdentitySelfTest(): {
    ...
    checks: {
        ...
        groupAgentHasHybridPlanner: boolean;
        groupPlanKeepsReadOnlyAuthoring: boolean;
        firstPlanLineOnce: boolean;
        projectHasFourSections: boolean;
        sharedToolCatalog: boolean;
        projectKeepsCodeAuthority: boolean;
        projectAgentHasHybridPlanner: boolean;
        projectPlanKeepsReadOnlyAuthoring: boolean;
        ...
        globalUsesHybridPlanning: boolean;
