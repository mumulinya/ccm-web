...
exports.compactUserFacingText = compactUserFacingText;
exports.sanitizeMainAgentRoleLanguage = sanitizeMainAgentRoleLanguage;
exports.sanitizeUserFacingTerminology = sanitizeUserFacingTerminology;
exports.sanitizeUserFacingProtocolTerms = sanitizeUserFacingProtocolTerms;
exports.sanitizeMainAgentUserFacingText = sanitizeMainAgentUserFacingText;
function compactUserFacingText(value, max = 260) {
...
function sanitizeUserFacingTerminology(value) {
    return String(value || "")
...
function sanitizeUserFacingProtocolTerms(value) {
    return String(value || "")
...
function sanitizeMainAgentUserFacingText(value) {
    return sanitizeMainAgentRoleLanguage(sanitizeUserFacingProtocolTerms(sanitizeUserFacingTerminology(value)))
        .replace(/([\u4e00-\u9fff])\s+([\u4e00-\u9fff])/g, "$1$2")
        .replace(/\s{2,}/g, " ")
        .trim();
}
//# sourceMappingURL=user-facing-text.js.map