...
function evaluateAgentDecision(input) {
    ...
    const grounded = !targets.requiresTarget || (targets.values.length > 0 && targets.values.every(value => isGrounded(value, input.message, input.priorSteps || [])
...
//# sourceMappingURL=quality-center.js.map