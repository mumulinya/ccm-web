...
export declare function resolveBundledFilesystemMcpEntry(): string;
export declare function isLegacyOfficialFilesystemMcpDefinition(value?: any): any;
export declare function buildBundledFilesystemMcpTool(fallback?: any): any;
