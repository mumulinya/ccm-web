...
function buildGlobalSystemHealth(resources = {}) {
    ...
    const supervisors = resources.supervisors || (0, global_mission_supervisor_1.listGlobalMissionSupervisors)({ limit: 100 });
...
function buildGlobalGovernanceSnapshot() {
    const tools = (0, global_agent_runtime_1.buildGlobalAgentToolDefinitions)(global_agent_loop_1.GLOBAL_AGENT_TOOL_SPECS);
    const permissions = (0, global_agent_runtime_1.loadGlobalAgentPermissionRules)();
    const hooks = (0, global_agent_runtime_1.loadGlobalAgentHooks)();
    const highRiskTools = global_agent_loop_1.GLOBAL_AGENT_TOOL_SPECS
...
function buildGlobalSupervisionDashboard(resources = {}) {
    const supervisors = resources.supervisors || (0, global_mission_supervisor_1.listGlobalMissionSupervisors)({ limit: 50 });
    return {
...
//# sourceMappingURL=global-agent-control-center.js.map