...
try {
  ...
  assert.throws(() => settings.saveAgentProviderSettings({ claudecode: { apiUrl: 'file:///secret' } }), /格式无效|HTTPS/)
  assert.throws(() => settings.saveAgentProviderSettings({ claudecode: { apiUrl: 'http://example.com' } }), /必须使用HTTPS/)
