...
const intakeRoutes = read('backend/modules/collaboration/collaboration-routes-part-02-part-01.ts')
const taskService = read('backend/modules/collaboration/collaboration-task-service.ts')
const queue = read('backend/modules/collaboration/collaboration-runtime-task-queue-part-02.ts')
const queueProcessor = read('backend/modules/collaboration/collaboration-runtime-coordinator-review-part-01.ts')
...
const groupLive = read('backend/modules/collaboration/group-live-routes-part-02-part-02.ts')
...
const taskRoutes = read('backend/modules/collaboration/collaboration-routes-part-03.ts')
