...
export function isLegacyFetchWebMcpDefinition(value: any = {}) {
  if (String(value?.name || "") !== FETCH_WEB_BUNDLED_MCP) return false;
...
export function buildBundledFetchWebMcpTool(fallback: any = {}) {
  const candidates = [
