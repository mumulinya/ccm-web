...
import { loadTemplates, saveTemplates } from "../../core/db";
...
function updateTemplate(id: string, updates: any) {
  const templates = getActiveTemplates();
...
// === 模板 API 路由路由分流 ===
export function handleTemplatesApi(pathname: string, req: any, res: any, parsed: any): boolean {
  // 1. 获取所有模板
