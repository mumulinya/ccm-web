// Behavior-freeze split from group-orchestrator-coded.ts (part 3/5).
...
import {
  pressureProvenanceProviderDispatchPolicyForCoordinator,
  pressureProvenanceProviderHealthForCoordinator,
  providerReliabilityConfiguredCandidatesForCoordinator,
  providerReliabilityHealthRankForCoordinator,
  providerReliabilityRiskRankForCoordinator,
  providerReliabilitySignalForAgentForCoordinator,
  providerSwitchExecutionRankPenaltyForCoordinator,
  providerSwitchExecutionRankingProvenanceForCoordinator,
