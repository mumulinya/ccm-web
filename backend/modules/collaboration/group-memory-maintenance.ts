// group-memory-maintenance.ts — merged from 3 part files (behavior-freeze merge).
...
// ===== merged from group-memory-maintenance-part-01.ts =====
...
// ===== merged from group-memory-maintenance-part-02.ts =====
...
// ===== merged from group-memory-maintenance-part-03.ts =====
