...
import { GROUP_TYPED_MEMORY_ENTRYPOINT, GROUP_TYPED_MEMORY_MANIFEST_MAX_FILES, GROUP_TYPED_MEMORY_MANIFEST_MAX_SELECTION, GROUP_TYPED_MEMORY_SHAPE_TREND_INCIDENT_LEDGER, GROUP_TYPED_MEMORY_SHAPE_TREND_INCIDENT_MAX_EVENTS, GROUP_TYPED_MEMORY_SHAPE_TREND_INCIDENT_RETENTION_DAYS, GROUP_TYPED_MEMORY_SHAPE_TREND_INCIDENT_VERSION, GROUP_TYPED_MEMORY_SHAPE_TREND_LEDGER, GROUP_TYPED_MEMORY_SHAPE_TREND_MAX_KEYS_PER_BUCKET, GROUP_TYPED_MEMORY_SHAPE_TREND_MUTABLE_DAYS, GROUP_TYPED_MEMORY_SHAPE_TREND_RETENTION_DAYS, GROUP_TYPED_MEMORY_SHAPE_TREND_VERSION, GROUP_TYPED_MEMORY_WRITE_SHAPE_DIR, GROUP_TYPED_MEMORY_WRITE_SHAPE_MAX_EVENTS, GROUP_TYPED_MEMORY_WRITE_SHAPE_VERSION, GroupTypedMemoryType, VALID_TYPES, checksum, compactText, getGroupTypedMemoryDir, groupTypedMemoryTextLineCount, isExactGroupTypedMemorySessionScope, normalizeMemoryType, now, safeSegment, uniqueStrings, writeTextAtomicRaw } from "./typed-memory-shared";
...
export function groupTypedMemoryWriteShapeChecksum(value: any) {
  const payload = { ...(value || {}) };
...
export function groupTypedMemoryShapeTrendBucketChecksum(value: any) {
  const payload = { ...(value || {}) };
  delete payload.checksum;
  return checksum(JSON.stringify(payload), 64);
}
...
export function groupTypedMemoryShapeTrendLedgerChecksum(value: any) {
  const payload = { ...(value || {}) };
  delete payload.checksum;
  delete payload.file;
...
export function groupTypedMemoryShapeTrendSummaryChecksum(value: any) {
  const payload = { ...(value || {}) };
  delete payload.checksum;
  return checksum(JSON.stringify(payload), 64);
}
...
export function groupTypedMemoryShapeTrendDate(value: any) {
  const ms = typeof value === "number" ? value : Date.parse(String(value || ""));
  return Number.isFinite(ms) ? new Date(ms).toISOString().slice(0, 10) : "";
}


export function emptyGroupTypedMemoryShapeTrendBucket(date: string) {
  return {
    date,
    sealed: false,
    sealedAt: "",
...
export function emptyGroupTypedMemoryShapeTrendLedger(scopeId: string) {
  const core = {
...
export function groupTypedMemoryShapeTrendMetricsValid(bucket: any) {
...
export function normalizeGroupTypedMemoryShapeTrendContribution(kind: string, input: any = {}) {
...
export function applyGroupTypedMemoryShapeTrendContribution(bucket: any, kind: string, metrics: any) {
  if (kind === "selector") {
...
export function rechainGroupTypedMemoryShapeTrendBuckets(buckets: any[]) {
...
export function summarizeGroupTypedMemoryShapeTrendBuckets(buckets: any[]) {
...
export function groupTypedMemoryShapeTrendIncidentEventChecksum(value: any) {
  const payload = { ...(value || {}) };
  delete payload.checksum;
  return checksum(JSON.stringify(payload), 64);
}
...
export function groupTypedMemoryShapeTrendIncidentLedgerChecksum(value: any) {
  const payload = { ...(value || {}) };
  delete payload.checksum;
  delete payload.file;
  delete payload.present;
...
export function groupTypedMemoryShapeTrendIncidentSummaryChecksum(value: any) {
  const payload = { ...(value || {}) };
  delete payload.checksum;
  return checksum(JSON.stringify(payload), 64);
}
...
export function groupTypedMemoryShapeTrendSignalState(trend: any) {
...
export function emptyGroupTypedMemoryShapeTrendIncidentLedger(scopeId: string) {
  const core = {
...
export function replayGroupTypedMemoryShapeTrendIncidentEvents(events: any[], expectedScopeId = "") {
...
export function appendGroupTypedMemoryShapeTrendIncidentEvent(ledger: any, scopeId: string, type: string, input: any = {}) {
...
export function compactGroupTypedMemoryShapeTrendIncidentEvents(events: any[], nowMs: number) {
...
export function commitGroupTypedMemoryShapeTrendIncidentLedger(file: string, ledger: any, scopeId: string, nowMs: number) {
...
export function groupTypedMemoryShapeDriftChecksum(value: any) {
  const payload = { ...(value || {}) };
  delete payload.checksum;
  delete payload.valid;
  return checksum(JSON.stringify(payload), 64);
...
export function summarizeGroupTypedMemoryShapeWindow(shapeRows: any[], writeRows: any[]) {
...
export function groupTypedMemoryShapeMetricDelta(recent: any, baseline: any, key: string) {
