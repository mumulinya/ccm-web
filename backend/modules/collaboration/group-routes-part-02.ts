// Behavior-freeze split from group-routes.ts (part 2/3).
...
import {
  buildGroupCompletionSummary,
  buildGroupCurrentTodoSummary,
  buildGroupPickupSummary,
  buildGroupProgressRefreshSummary,
  checkpointStatus,
  compactGroupStatusText,
  getGroupStatusIndependentReviewSummary,
  getGroupStatusTestAgentExecutionPlanSummary,
  groupDeliveryCheckpointLabel,
  groupStatusPhaseNeedsUserAction,
  groupTaskDisplayStatus,
  groupTaskStatusMeta,
  groupTodoTextNeedsUserAction,
  summarizeGroupStatusIndependentReview,
  summarizeGroupStatusTestAgentExecutionPlan,
  taskUpdatedMs,
