...
import {
  GROUP_AUTOCOMPACT_BUFFER_TOKENS,
  GROUP_COMPACT_MIN_KEEP_MESSAGES,
  GROUP_COMPACT_MIN_KEEP_TOKENS,
  GROUP_COMPACT_STRATEGY_DECISION_VERSION,
  GROUP_CONTEXT_RESERVED_TOKENS,
  GROUP_ERROR_BUFFER_TOKENS,
  GROUP_MANUAL_COMPACT_BUFFER_TOKENS,
  GROUP_PARTIAL_COMPACT_VERSION,
  GROUP_PTL_EMERGENCY_VERSION,
  GROUP_PTL_RECOVERY_VERSION,
  GROUP_WARNING_BUFFER_TOKENS,
} from "./group-compaction-receipts";
import {
  buildGroupPreservedSegment,
  collectWindowBlockRefs,
  compactText,
...
export function buildGroupCompactWindowInvariants(input: any = {}) {
...
export function resolvePartialCompactWindow(messages: any[], previousBoundaryIndex: number, options: any = {}) {
...
export function buildGroupPtlEmergencyPlan(input: any) {
