...
} from "../tasks/task-agent-memory-entry-sync";
import {
...
// ===== merged from runtime-kernel-part-01-part-01.ts =====
...
export function buildWorkerMemoryRecallTrustContract(memory: any = null, memoryPolicy: any = {}, deliveryCapsuleInput: any = null, expectedBinding: any = null) {
...
export function renderWorkerMemoryRecallTrustContract(contract: any = null) {
...
export function extractPressureMemoryProvenanceReceiptDiscipline(memory: any = {}, fallback: any = null) {
...
export function renderPressureMemoryProvenanceReceiptDiscipline(discipline: any = {}) {
...
export function extractPressureProvenanceDispatchFeedbackPolicy(memory: any = {}, fallback: any = null) {
  const candidate = fallback
...
export function renderPressureProvenanceDispatchFeedbackPolicy(policy: any = {}) {
...
export function extractPressureProvenanceProviderDispatchAdvisory(memory: any = {}, fallback: any = null) {
  const candidate = fallback
...
export function renderPressureProvenanceProviderDispatchAdvisory(advisory: any = {}) {
...
export function renderProviderSwitchDecisionReceipt(receipt: any = {}) {
...
export function extractProviderRankingCompactRepairReceiptMemoryContract(memory: any = {}, fallback: any = null) {
  const candidate = fallback
...
export function renderProviderRankingCompactRepairReceiptMemoryContract(contract: any = {}) {
...
export function extractPostCompactReinjectionRepairReceiptMemoryContract(memory: any = {}, fallback: any = null) {
  const candidate = fallback
...
export function renderPostCompactReinjectionRepairReceiptMemoryContract(contract: any = {}) {
  if (!contract?.schema || contract.active === false) return "";
  const docRelPaths = uniqueRuntimeStrings([
...
// ===== merged from runtime-kernel-part-02.ts =====
