...
export function uniqueDeliveryStrings(...lists: any[]) {
...
export function uniqueDeliveryLines(...lists: any[]) {
  const seen = new Set<string>();
  const result: string[] = [];
  for (const list of lists) {
...
export function firstObject(...values: any[]) {
  return values.find(value => value && typeof value === "object" && !Array.isArray(value)) || null;
}

export function firstBoolean(...values: any[]) {
...
export function normalizeDeliveryStatus(status: any): MainAgentDeliveryStatus {
...
export function hasBlockingDeliveryCompletionGap(input: MainAgentDeliveryReportInput) {
...
export function deliveryStatusLabel(status: MainAgentDeliveryStatus) {
...
export function deliveryTitle(status: MainAgentDeliveryStatus) {
...
export function getNestedReport(input: MainAgentDeliveryReportInput) {
...
export function collectDeliveryFiles(input: MainAgentDeliveryReportInput) {
...
export function collectDeliveryVerification(input: MainAgentDeliveryReportInput) {
  const { report, summary, completion, workchainSummary } = getNestedReport(input);
  const task = input.task || {};
...
export function collectFailedDeliveryVerificationEvidence(input: MainAgentDeliveryReportInput) {
  const { report, summary, completion, workchainSummary } = getNestedReport(input);
...
export function collectIncompleteDeliveryVerificationEvidence(input: MainAgentDeliveryReportInput) {
  return uniqueDeliveryLines(
    collectRawDeliveryVerificationEvidence(input).map(deliveryVerificationIncompleteSummary),
  ).slice(0, 8);
}

export function collectWeakMissingDeliveryVerificationEvidence(input: MainAgentDeliveryReportInput) {
  const { report, summary, completion, workchainSummary } = getNestedReport(input);
...
export function collectDeliveryVerificationEvidence(input: MainAgentDeliveryReportInput, status: MainAgentDeliveryStatus) {
  const { report, summary, completion, workchainSummary } = getNestedReport(input);
  const task = input.task || {};
  const executedExplicit = uniqueDeliveryStrings(
    report.verification_executed,
...
export function collectFailedIndependentReviewEvidence(input: MainAgentDeliveryReportInput) {
  return uniqueDeliveryLines(
...
export function collectIncompleteIndependentReviewEvidence(input: MainAgentDeliveryReportInput) {
  return uniqueDeliveryLines(
...
export function collectWeakPassedIndependentReviewEvidence(input: MainAgentDeliveryReportInput) {
  const { report, summary, completion, workchainSummary } = getNestedReport(input);
  const task = input.task || {};
  const gate = firstObject(
    report.independent_review_gate,
...
export function formatDeliveryIndependentReviewEvidence(item: any) {
