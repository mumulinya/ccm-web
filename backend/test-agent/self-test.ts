...
function writeSolidRgbaPng(filePath: string, width: number, height: number, rgba: [number, number, number, number]) {
...
function buildStoredZip(entries: Array<{ name: string; data: Buffer | string }>) {
