// self-test-playwright-cli.ts — merged from 6 part files (behavior-freeze merge).
...
// ===== merged from self-test-playwright-cli/part-01.ts =====
    ...
    projects: [{
      ...
      browserChecks: [{
        ...
        actions: [
          ...
          { action: "attach_file", label: "Attachment", file_name: "notes.txt", file_content: payload, media_type: "text/plain", exact: true } as any,
    ...
    projects: [{
      ...
      browserChecks: [{
        ...
        assertions: [
          ...
          { assertion: "element_in_viewport", testId: "cta" } as any,
          { type: "consoleNoErrors" },
          { type: "networkNoErrors" },
        ],
        screenshot: true,
    ...
    projects: [{
      ...
      browserChecks: [{
        ...
        assertions: [
          ...
          { assertion: "no_horizontal_overflow" } as any,
          { type: "consoleNoErrors" },
          { type: "networkNoErrors" },
        ],
        screenshot: true,
...
// ===== merged from self-test-playwright-cli/part-02.ts =====
...
// ===== merged from self-test-playwright-cli/part-03-fixtures-part-01.ts =====
...
// ===== merged from self-test-playwright-cli/part-03-fixtures-part-02.ts =====
...
// ===== merged from self-test-playwright-cli/part-03.ts =====
...
// ===== merged from self-test-playwright-cli/part-04.ts =====
