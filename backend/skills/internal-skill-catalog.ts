...
export const CCM_INTERNAL_SKILL_CATALOG: ReadonlyArray<{
  ...
  { name: CCM_ROLE_SKILL_NAMES.implementationPlanAuthoring, description: "Author a user-confirmable implementation plan card with operational rules and demoable delivery slices before dispatch." },
